...
{
	/// <summary>
	/// The collection to hold 'ProductSalesfor1997' entities
	/// </summary>
	[EdmEntityTypeAttribute(NamespaceName = "Acme.Northwind.EFDAL.Entity", Name = "ProductSalesfor1997")]
	[Serializable]
	[DataContractAttribute(IsReference = true)]
	[nHydrate.EFCore.Attributes.FieldNameConstantsAttribute(typeof(Acme.Northwind.EFDAL.Entity.ProductSalesfor1997.FieldNameConstants))]
	[System.ComponentModel.ImmutableObject(true)]
	[System.CodeDom.Compiler.GeneratedCode("nHydrateModelGenerator", "5.1.2")]
	public partial class ProductSalesfor1997 : nHydrate.EFCore.DataAccess.NHEntityObject, nHydrate.EFCore.DataAccess.IReadOnlyBusinessObject, Acme.Northwind.EFDAL.Interfaces.Entity.IProductSalesfor1997, System.IEquatable<Acme.Northwind.EFDAL.Interfaces.Entity.IProductSalesfor1997>
	{
		#region FieldNameConstants Enumeration

		/// <summary>
		/// Enumeration to define each property that maps to a database field for the 'ProductSalesfor1997' customView.
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the Acme.Northwind.EFDAL.Entity.ProductSalesfor1997 class
		/// </summary>
		protected internal ProductSalesfor1997()
		{
		}
		...
		public virtual string CategoryName
		{
			...
			set
			{
				if ((value != null) && (value.Length > GetMaxLength(FieldNameConstants.CategoryName))) throw new Exception(string.Format(GlobalValues.ERROR_DATA_TOO_BIG, value, "ProductSalesfor1997.CategoryName", GetMaxLength(FieldNameConstants.CategoryName)));
		...
		public virtual string ProductName
		{
			...
			set
			{
				if ((value != null) && (value.Length > GetMaxLength(FieldNameConstants.ProductName))) throw new Exception(string.Format(GlobalValues.ERROR_DATA_TOO_BIG, value, "ProductSalesfor1997.ProductName", GetMaxLength(FieldNameConstants.ProductName)));
		...
		{
			return ((System.IEquatable<Acme.Northwind.EFDAL.Interfaces.Entity.IProductSalesfor1997>)this).Equals(item as Acme.Northwind.EFDAL.Interfaces.Entity.IProductSalesfor1997);
		}

		#endregion

		#region Equals
		bool System.IEquatable<Acme.Northwind.EFDAL.Interfaces.Entity.IProductSalesfor1997>.Equals(Acme.Northwind.EFDAL.Interfaces.Entity.IProductSalesfor1997 other)
		{
		...
		{
			var other = obj as Acme.Northwind.EFDAL.Entity.ProductSalesfor1997;
		...
		/// Gets the value of one of this object's properties.
		/// </summary>
		public double GetDouble(Acme.Northwind.EFDAL.Entity.ProductSalesfor1997.FieldNameConstants field, double defaultValue)
		{
			var o = this.GetValue(field, defaultValue);
			if (o is string)
			{
		...
		/// </summary>
		internal static string GetDatabaseFieldName(ProductSalesfor1997.FieldNameConstants field)
		{

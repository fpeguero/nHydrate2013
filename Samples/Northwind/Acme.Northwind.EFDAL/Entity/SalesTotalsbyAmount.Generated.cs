...
{
	/// <summary>
	/// The collection to hold 'SalesTotalsbyAmount' entities
	/// </summary>
	[EdmEntityTypeAttribute(NamespaceName = "Acme.Northwind.EFDAL.Entity", Name = "SalesTotalsbyAmount")]
	[Serializable]
	[DataContractAttribute(IsReference = true)]
	[nHydrate.EFCore.Attributes.FieldNameConstantsAttribute(typeof(Acme.Northwind.EFDAL.Entity.SalesTotalsbyAmount.FieldNameConstants))]
	[System.ComponentModel.ImmutableObject(true)]
	[System.CodeDom.Compiler.GeneratedCode("nHydrateModelGenerator", "5.1.2")]
	public partial class SalesTotalsbyAmount : nHydrate.EFCore.DataAccess.NHEntityObject, nHydrate.EFCore.DataAccess.IReadOnlyBusinessObject, Acme.Northwind.EFDAL.Interfaces.Entity.ISalesTotalsbyAmount, System.IEquatable<Acme.Northwind.EFDAL.Interfaces.Entity.ISalesTotalsbyAmount>
	{
		#region FieldNameConstants Enumeration

		/// <summary>
		/// Enumeration to define each property that maps to a database field for the 'SalesTotalsbyAmount' customView.
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the Acme.Northwind.EFDAL.Entity.SalesTotalsbyAmount class
		/// </summary>
		protected internal SalesTotalsbyAmount()
		{
		}
		...
		public virtual string CompanyName
		{
			...
			set
			{
				if ((value != null) && (value.Length > GetMaxLength(FieldNameConstants.CompanyName))) throw new Exception(string.Format(GlobalValues.ERROR_DATA_TOO_BIG, value, "SalesTotalsbyAmount.CompanyName", GetMaxLength(FieldNameConstants.CompanyName)));
		...
		[DataMemberAttribute()]
		[System.ComponentModel.DisplayName("SaleAmount")]
		[System.ComponentModel.ReadOnly(true)]
		[System.Diagnostics.DebuggerNonUserCode]
		public virtual decimal? SaleAmount
		{
			...
			set
			{
				var eventArg = new nHydrate.EFCore.EventArgs.ChangingEventArgs<decimal?>(value, "SaleAmount");
				//this.OnSaleAmountChanging(eventArg);
				if (eventArg.Cancel) return;
				ReportPropertyChanging("SaleAmount");
				_saleAmount = eventArg.Value;
				ReportPropertyChanged("SaleAmount");
				//this.OnSaleAmountChanged(eventArg);
			}
		}
		...
		/// <summary>
		/// The internal reference variable for the 'SaleAmount' property
		/// </summary>
		...
		{
			return ((System.IEquatable<Acme.Northwind.EFDAL.Interfaces.Entity.ISalesTotalsbyAmount>)this).Equals(item as Acme.Northwind.EFDAL.Interfaces.Entity.ISalesTotalsbyAmount);
		}

		#endregion

		#region Equals
		bool System.IEquatable<Acme.Northwind.EFDAL.Interfaces.Entity.ISalesTotalsbyAmount>.Equals(Acme.Northwind.EFDAL.Interfaces.Entity.ISalesTotalsbyAmount other)
		{
		...
		{
			var other = obj as Acme.Northwind.EFDAL.Entity.SalesTotalsbyAmount;
		...
		/// Gets the value of one of this object's properties.
		/// </summary>
		public int GetInteger(Acme.Northwind.EFDAL.Entity.SalesTotalsbyAmount.FieldNameConstants field)
		{
		...
		/// Gets the value of one of this object's properties.
		/// </summary>
		public int GetInteger(Acme.Northwind.EFDAL.Entity.SalesTotalsbyAmount.FieldNameConstants field, int defaultValue)
		{
		...
		/// Gets the value of one of this object's properties.
		/// </summary>
		public double GetDouble(Acme.Northwind.EFDAL.Entity.SalesTotalsbyAmount.FieldNameConstants field)
		{
		...
		/// Gets the value of one of this object's properties.
		/// </summary>
		public double GetDouble(Acme.Northwind.EFDAL.Entity.SalesTotalsbyAmount.FieldNameConstants field, double defaultValue)
		{
			var o = this.GetValue(field, defaultValue);
			if (o is string)
			{
		...
		/// Gets the value of one of this object's properties.
		/// </summary>
		public System.DateTime GetDateTime(Acme.Northwind.EFDAL.Entity.SalesTotalsbyAmount.FieldNameConstants field)
		{
		...
		/// Gets the value of one of this object's properties.
		/// </summary>
		public System.DateTime GetDateTime(Acme.Northwind.EFDAL.Entity.SalesTotalsbyAmount.FieldNameConstants field, System.DateTime defaultValue)
		{
			var o = this.GetValue(field, defaultValue);
			if (o is string)
			{
		...
		/// Gets the value of one of this object's properties.
		/// </summary>
		public string GetString(Acme.Northwind.EFDAL.Entity.SalesTotalsbyAmount.FieldNameConstants field)
		{
		...
		/// Gets the value of one of this object's properties.
		/// </summary>
		public string GetString(Acme.Northwind.EFDAL.Entity.SalesTotalsbyAmount.FieldNameConstants field, string defaultValue)
		{
			var o = this.GetValue(field, defaultValue);
			if (o is string)
			{
		...
		/// </summary>
		internal static string GetDatabaseFieldName(SalesTotalsbyAmount.FieldNameConstants field)
		{
		...
		internal static string GetDatabaseFieldName(string field)
		{
			switch (field)
			{
				...
				case "SaleAmount": return "SaleAmount";

...
namespace Acme.Northwind.EFDAL.Entity
{
	...
	[EdmEntityTypeAttribute(NamespaceName = "Acme.Northwind.EFDAL.Entity", Name = "Customer")]
	[Serializable]
	[DataContractAttribute(IsReference = true)]
	[nHydrate.EFCore.Attributes.FieldNameConstantsAttribute(typeof(Acme.Northwind.EFDAL.Entity.Customer.FieldNameConstants))]
	[System.ComponentModel.DataAnnotations.MetadataType(typeof(Acme.Northwind.EFDAL.Interfaces.Entity.Metadata.CustomerMetadata))]
	[nHydrate.EFCore.Attributes.EntityMetadata("Customer", false, true, true, true, "", true, false, false, "dbo")]
	public partial class Customer : nHydrate.EFCore.DataAccess.NHEntityObject, nHydrate.EFCore.DataAccess.IBusinessObject, Acme.Northwind.EFDAL.IEntityWithContext, System.ComponentModel.IDataErrorInfo, Acme.Northwind.EFDAL.Interfaces.Entity.ICustomer, System.ICloneable, System.IEquatable<Acme.Northwind.EFDAL.Interfaces.Entity.ICustomer>, nHydrate.EFCore.DataAccess.IAuditable
	{
		...
		/// <summary>
		/// Initializes a new instance of the Acme.Northwind.EFDAL.Entity.Customer class
		/// </summary>
		public Customer()
		{
			this.OnCreated();
		...
		/// <summary>
		/// Initializes a new instance of the Acme.Northwind.EFDAL.Entity.Customer class with a defined primary key
		/// </summary>
		...
		/// </summary>
		/// <remarks>Field: [Customers].[Address], Field Length: 60, Nullable</remarks>
		...
		/// </summary>
		/// <remarks>Field: [Customers].[City], Field Length: 15, Nullable, Indexed</remarks>
		[System.ComponentModel.Browsable(true)]
		[EdmScalarPropertyAttribute(EntityKeyProperty = false, IsNullable = true)]
		[DataMemberAttribute()]
		...
		/// </summary>
		/// <remarks>Field: [Customers].[CompanyName], Field Length: 40, Not Nullable, Indexed</remarks>
		[System.ComponentModel.Browsable(true)]
		...
		/// </summary>
		/// <remarks>Field: [Customers].[ContactName], Field Length: 30, Nullable</remarks>
		[System.ComponentModel.Browsable(true)]
		[EdmScalarPropertyAttribute(EntityKeyProperty = false, IsNullable = true)]
		[DataMemberAttribute()]
		...
		public virtual string ContactName
		{
			...
			set
			{
				...
				if ((value != null) && (value.Length > GetMaxLength(FieldNameConstants.ContactName))) throw new Exception(string.Format(GlobalValues.ERROR_DATA_TOO_BIG, value, "Customer.ContactName", GetMaxLength(FieldNameConstants.ContactName)));
		...
		/// </summary>
		/// <remarks>Field: [Customers].[ContactTitle], Field Length: 30, Nullable</remarks>
		[System.ComponentModel.Browsable(true)]
		[EdmScalarPropertyAttribute(EntityKeyProperty = false, IsNullable = true)]
		[DataMemberAttribute()]
		...
		public virtual string ContactTitle
		{
			...
			set
			{
				...
				if ((value != null) && (value.Length > GetMaxLength(FieldNameConstants.ContactTitle))) throw new Exception(string.Format(GlobalValues.ERROR_DATA_TOO_BIG, value, "Customer.ContactTitle", GetMaxLength(FieldNameConstants.ContactTitle)));
		...
		/// </summary>
		/// <remarks>Field: [Customers].[Country], Field Length: 15, Nullable</remarks>
		[System.ComponentModel.Browsable(true)]
		[EdmScalarPropertyAttribute(EntityKeyProperty = false, IsNullable = true)]
		[DataMemberAttribute()]
		...
		/// </summary>
		/// <remarks>Field: [Customers].[CustomerID], Field Length: 5, Not Nullable, Primary Key, Unique, Indexed</remarks>
		[System.ComponentModel.Browsable(true)]
		...
		public virtual string CustomerID
		{
			...
			set
			{
				...
				if ((value != null) && (value.Length > GetMaxLength(FieldNameConstants.CustomerID))) throw new Exception(string.Format(GlobalValues.ERROR_DATA_TOO_BIG, value, "Customer.CustomerID", GetMaxLength(FieldNameConstants.CustomerID)));
		...
		/// </summary>
		/// <remarks>Field: [Customers].[Fax], Field Length: 24, Nullable</remarks>
		[System.ComponentModel.Browsable(true)]
		[EdmScalarPropertyAttribute(EntityKeyProperty = false, IsNullable = true)]
		[DataMemberAttribute()]
		...
		/// </summary>
		/// <remarks>Field: [Customers].[Phone], Field Length: 24, Nullable</remarks>
		[System.ComponentModel.Browsable(true)]
		[EdmScalarPropertyAttribute(EntityKeyProperty = false, IsNullable = true)]
		[DataMemberAttribute()]
		...
		/// </summary>
		/// <remarks>Field: [Customers].[PostalCode], Field Length: 10, Nullable, Indexed</remarks>
		[System.ComponentModel.Browsable(true)]
		[EdmScalarPropertyAttribute(EntityKeyProperty = false, IsNullable = true)]
		[DataMemberAttribute()]
		...
		/// </summary>
		/// <remarks>Field: [Customers].[Region], Field Length: 15, Nullable, Indexed</remarks>
		[System.ComponentModel.Browsable(true)]
		[EdmScalarPropertyAttribute(EntityKeyProperty = false, IsNullable = true)]
		[DataMemberAttribute()]
		...
		public static System.Type GetFieldType(FieldNameConstants field)
		{
			if (field.GetType() != typeof(FieldNameConstants))
				throw new Exception("The '" + field.GetType().ReflectedType.ToString() + ".FieldNameConstants' value is not valid. The field parameter must be of type 'Acme.Northwind.EFDAL.Entity.Customer.FieldNameConstants'.");
		...
		System.Type nHydrate.EFCore.DataAccess.IReadOnlyBusinessObject.GetFieldType(Enum field)
		{
			...
			return GetFieldType((Acme.Northwind.EFDAL.Entity.Customer.FieldNameConstants)field);
		}
		...
		/// Creates a shallow copy of this object
		/// </summary>
		public static Customer Clone(Acme.Northwind.EFDAL.Interfaces.Entity.ICustomer item)
		{
			var newItem = new Customer();
		...
		{
			return ((System.IEquatable<Acme.Northwind.EFDAL.Interfaces.Entity.ICustomer>)this).Equals(item as Acme.Northwind.EFDAL.Interfaces.Entity.ICustomer);
		}
		...
		[XmlIgnoreAttribute()]
		[SoapIgnoreAttribute()]
		[EdmRelationshipNavigationPropertyAttribute("Acme.Northwind.EFDAL.Entity", "FK__CustomerCustomerDemo_Customer", "CustomerCustomerDemoList")]
		public virtual EntityCollection<Acme.Northwind.EFDAL.Entity.CustomerCustomerDemo> CustomerCustomerDemoList
		{
			get
			{
				//Eager load
				var retval = ((System.Data.Objects.DataClasses.IEntityWithRelationships)this).RelationshipManager.GetRelatedCollection<Acme.Northwind.EFDAL.Entity.CustomerCustomerDemo>("Acme.Northwind.EFDAL.Entity.FK__CustomerCustomerDemo_Customer", "CustomerCustomerDemoList");
		...
		System.Collections.Generic.ICollection<Acme.Northwind.EFDAL.Interfaces.Entity.ICustomerCustomerDemo> Acme.Northwind.EFDAL.Interfaces.Entity.ICustomer.CustomerCustomerDemoList
		{
			get { return (System.Collections.Generic.ICollection<Acme.Northwind.EFDAL.Interfaces.Entity.ICustomerCustomerDemo>)(System.Collections.Generic.ICollection<CustomerCustomerDemo>)this.CustomerCustomerDemoList; }
		}
		...
		[XmlIgnoreAttribute()]
		[SoapIgnoreAttribute()]
		[EdmRelationshipNavigationPropertyAttribute("Acme.Northwind.EFDAL.Entity", "FK__Order_Customer", "OrderList")]
		public virtual EntityCollection<Acme.Northwind.EFDAL.Entity.Order> OrderList
		{
			get
			{
				//Eager load
				var retval = ((System.Data.Objects.DataClasses.IEntityWithRelationships)this).RelationshipManager.GetRelatedCollection<Acme.Northwind.EFDAL.Entity.Order>("Acme.Northwind.EFDAL.Entity.FK__Order_Customer", "OrderList");
				if (!retval.IsLoaded  && this.EntityState != System.Data.EntityState.Added && this.EntityState != System.Data.EntityState.Detached)
				{
					retval.Load();
				}
		...
		System.Collections.Generic.ICollection<Acme.Northwind.EFDAL.Interfaces.Entity.IOrder> Acme.Northwind.EFDAL.Interfaces.Entity.ICustomer.OrderList
		{
		...
		{
			sql = System.Text.RegularExpressions.Regex.Replace(sql, "\\[" + parentAlias + "\\]\\.\\[address\\]", "[" + childTables.GetBaseAliasTable(parentAlias, "Customers") + "].[address]", RegexOptions.IgnoreCase);
			sql = System.Text.RegularExpressions.Regex.Replace(sql, "\\[" + parentAlias + "\\]\\.\\[city\\]", "[" + childTables.GetBaseAliasTable(parentAlias, "Customers") + "].[city]", RegexOptions.IgnoreCase);
			sql = System.Text.RegularExpressions.Regex.Replace(sql, "\\[" + parentAlias + "\\]\\.\\[companyname\\]", "[" + childTables.GetBaseAliasTable(parentAlias, "Customers") + "].[companyname]", RegexOptions.IgnoreCase);
			sql = System.Text.RegularExpressions.Regex.Replace(sql, "\\[" + parentAlias + "\\]\\.\\[contactname\\]", "[" + childTables.GetBaseAliasTable(parentAlias, "Customers") + "].[contactname]", RegexOptions.IgnoreCase);
			sql = System.Text.RegularExpressions.Regex.Replace(sql, "\\[" + parentAlias + "\\]\\.\\[contacttitle\\]", "[" + childTables.GetBaseAliasTable(parentAlias, "Customers") + "].[contacttitle]", RegexOptions.IgnoreCase);
			sql = System.Text.RegularExpressions.Regex.Replace(sql, "\\[" + parentAlias + "\\]\\.\\[country\\]", "[" + childTables.GetBaseAliasTable(parentAlias, "Customers") + "].[country]", RegexOptions.IgnoreCase);
			sql = System.Text.RegularExpressions.Regex.Replace(sql, "\\[" + parentAlias + "\\]\\.\\[customerid\\]", "[" + childTables.GetBaseAliasTable(parentAlias, "Customers") + "].[customerid]", RegexOptions.IgnoreCase);
			sql = System.Text.RegularExpressions.Regex.Replace(sql, "\\[" + parentAlias + "\\]\\.\\[fax\\]", "[" + childTables.GetBaseAliasTable(parentAlias, "Customers") + "].[fax]", RegexOptions.IgnoreCase);
			sql = System.Text.RegularExpressions.Regex.Replace(sql, "\\[" + parentAlias + "\\]\\.\\[phone\\]", "[" + childTables.GetBaseAliasTable(parentAlias, "Customers") + "].[phone]", RegexOptions.IgnoreCase);
			sql = System.Text.RegularExpressions.Regex.Replace(sql, "\\[" + parentAlias + "\\]\\.\\[postalcode\\]", "[" + childTables.GetBaseAliasTable(parentAlias, "Customers") + "].[postalcode]", RegexOptions.IgnoreCase);
			sql = System.Text.RegularExpressions.Regex.Replace(sql, "\\[" + parentAlias + "\\]\\.\\[region\\]", "[" + childTables.GetBaseAliasTable(parentAlias, "Customers") + "].[region]", RegexOptions.IgnoreCase);
			sql = System.Text.RegularExpressions.Regex.Replace(sql, "\\[" + parentAlias + "\\]\\.\\[createdby\\]", "[" + childTables.GetBaseAliasTable(parentAlias, "Customers") + "].[createdby]", RegexOptions.IgnoreCase);
			sql = System.Text.RegularExpressions.Regex.Replace(sql, "\\[" + parentAlias + "\\]\\.\\[createddate\\]", "[" + childTables.GetBaseAliasTable(parentAlias, "Customers") + "].[createddate]", RegexOptions.IgnoreCase);
			sql = System.Text.RegularExpressions.Regex.Replace(sql, "\\[" + parentAlias + "\\]\\.\\[modifiedby\\]", "[" + childTables.GetBaseAliasTable(parentAlias, "Customers") + "].[modifiedby]", RegexOptions.IgnoreCase);
			sql = System.Text.RegularExpressions.Regex.Replace(sql, "\\[" + parentAlias + "\\]\\.\\[modifieddate\\]", "[" + childTables.GetBaseAliasTable(parentAlias, "Customers") + "].[modifieddate]", RegexOptions.IgnoreCase);
			sql = System.Text.RegularExpressions.Regex.Replace(sql, "\\[" + parentAlias + "\\]\\.\\[timestamp\\]", "[" + childTables.GetBaseAliasTable(parentAlias, "Customers") + "].[timestamp]", RegexOptions.IgnoreCase);
			return sql;
		}
		...
		public static int DeleteData(Expression<Func<Acme.Northwind.EFDAL.CustomerQuery, bool>> where)
		{
		...
		/// <returns>The number of rows deleted</returns>
		public static int DeleteData(Expression<Func<Acme.Northwind.EFDAL.CustomerQuery, bool>> where, string connectionString)
		{
		...
		/// <returns>The number of rows deleted</returns>
		public static int DeleteData(Expression<Func<Acme.Northwind.EFDAL.CustomerQuery, bool>> where, nHydrate.EFCore.DataAccess.QueryOptimizer optimizer)
		{
		...
		/// <param name="connectionString">The database connection string to use for this access</param>
		/// <returns>The number of rows deleted</returns>
		public static int DeleteData(Expression<Func<Acme.Northwind.EFDAL.CustomerQuery, bool>> where, nHydrate.EFCore.DataAccess.QueryOptimizer optimizer, string connectionString)
		{
			if (optimizer == null)
			...
			var template = dc.GetTable<Acme.Northwind.EFDAL.CustomerQuery>();
			var cmd = nHydrate.EFCore.DataAccess.BusinessEntityQuery.GetCommand<Acme.Northwind.EFDAL.CustomerQuery>(dc, template, where);
			...
			sql += "DELETE [Customers] FROM [dbo].[Customers] " + noLock + "INNER JOIN #t ON [dbo].[Customers].[CustomerID] = #t.[CustomerID]\r\n";
			sql += ";select @@rowcount";
			cmd.CommandText = sql;
			dc.Connection.Open();
		...
		public static int UpdateData(Expression<Func<Acme.Northwind.EFDAL.CustomerQuery, int>> select, Expression<Func<Acme.Northwind.EFDAL.CustomerQuery, bool>> where, int newValue)
		{
			return BusinessObjectQuery<Acme.Northwind.EFDAL.Entity.Customer, Acme.Northwind.EFDAL.CustomerQuery, int>.UpdateData(select, where, newValue, "Customers", GetDatabaseFieldName, true);
		}
		...
		/// <returns>The number of records affected</returns>
		public static int UpdateData(Expression<Func<Acme.Northwind.EFDAL.CustomerQuery, int>> select, Expression<Func<Acme.Northwind.EFDAL.CustomerQuery, bool>> where, int newValue, string connectionString)
		{
			return BusinessObjectQuery<Acme.Northwind.EFDAL.Entity.Customer, Acme.Northwind.EFDAL.CustomerQuery, int>.UpdateData(select, where, newValue, "Customers", GetDatabaseFieldName, true, connectionString);
		}
		...
		/// <param name="newValue">The new value to set the specified field in all matching records</param>
		/// <returns>The number of records affected</returns>
		public static int UpdateData(Expression<Func<Acme.Northwind.EFDAL.CustomerQuery, Single>> select, Expression<Func<Acme.Northwind.EFDAL.CustomerQuery, bool>> where, Single newValue)
		{
			return BusinessObjectQuery<Acme.Northwind.EFDAL.Entity.Customer, Acme.Northwind.EFDAL.CustomerQuery, Single>.UpdateData(select, where, newValue, "Customers", GetDatabaseFieldName, true);
		}
		...
		/// <param name="connectionString">The daatbase connection string</param>
		/// <returns>The number of records affected</returns>
		public static int UpdateData(Expression<Func<Acme.Northwind.EFDAL.CustomerQuery, Single>> select, Expression<Func<Acme.Northwind.EFDAL.CustomerQuery, bool>> where, Single newValue, string connectionString)
		{
			return BusinessObjectQuery<Acme.Northwind.EFDAL.Entity.Customer, Acme.Northwind.EFDAL.CustomerQuery, Single>.UpdateData(select, where, newValue, "Customers", GetDatabaseFieldName, true, connectionString);
		}
		...
		/// <param name="newValue">The new value to set the specified field in all matching records</param>
		/// <returns>The number of records affected</returns>
		public static int UpdateData(Expression<Func<Acme.Northwind.EFDAL.CustomerQuery, decimal>> select, Expression<Func<Acme.Northwind.EFDAL.CustomerQuery, bool>> where, decimal newValue)
		{
			return BusinessObjectQuery<Acme.Northwind.EFDAL.Entity.Customer, Acme.Northwind.EFDAL.CustomerQuery, decimal>.UpdateData(select, where, newValue, "Customers", GetDatabaseFieldName, true);
		}
		...
		/// <param name="connectionString">The daatbase connection string</param>
		/// <returns>The number of records affected</returns>
		public static int UpdateData(Expression<Func<Acme.Northwind.EFDAL.CustomerQuery, decimal>> select, Expression<Func<Acme.Northwind.EFDAL.CustomerQuery, bool>> where, decimal newValue, string connectionString)
		{
			return BusinessObjectQuery<Acme.Northwind.EFDAL.Entity.Customer, Acme.Northwind.EFDAL.CustomerQuery, decimal>.UpdateData(select, where, newValue, "Customers", GetDatabaseFieldName, true, connectionString);
		}
		...
		/// <param name="newValue">The new value to set the specified field in all matching records</param>
		/// <returns>The number of records affected</returns>
		public static int UpdateData(Expression<Func<Acme.Northwind.EFDAL.CustomerQuery, double>> select, Expression<Func<Acme.Northwind.EFDAL.CustomerQuery, bool>> where, double newValue)
		{
			return BusinessObjectQuery<Acme.Northwind.EFDAL.Entity.Customer, Acme.Northwind.EFDAL.CustomerQuery, double>.UpdateData(select, where, newValue, "Customers", GetDatabaseFieldName, true);
		}
		...
		/// <param name="connectionString">The daatbase connection string</param>
		/// <returns>The number of records affected</returns>
		public static int UpdateData(Expression<Func<Acme.Northwind.EFDAL.CustomerQuery, double>> select, Expression<Func<Acme.Northwind.EFDAL.CustomerQuery, bool>> where, double newValue, string connectionString)
		{
			return BusinessObjectQuery<Acme.Northwind.EFDAL.Entity.Customer, Acme.Northwind.EFDAL.CustomerQuery, double>.UpdateData(select, where, newValue, "Customers", GetDatabaseFieldName, true, connectionString);
		}
		...
		/// <param name="newValue">The new value to set the specified field in all matching records</param>
		/// <returns>The number of records affected</returns>
		public static int UpdateData(Expression<Func<Acme.Northwind.EFDAL.CustomerQuery, short>> select, Expression<Func<Acme.Northwind.EFDAL.CustomerQuery, bool>> where, short newValue)
		{
			return BusinessObjectQuery<Acme.Northwind.EFDAL.Entity.Customer, Acme.Northwind.EFDAL.CustomerQuery, short>.UpdateData(select, where, newValue, "Customers", GetDatabaseFieldName, true);
		}
		...
		/// <param name="connectionString">The daatbase connection string</param>
		/// <returns>The number of records affected</returns>
		public static int UpdateData(Expression<Func<Acme.Northwind.EFDAL.CustomerQuery, short>> select, Expression<Func<Acme.Northwind.EFDAL.CustomerQuery, bool>> where, short newValue, string connectionString)
		{
			return BusinessObjectQuery<Acme.Northwind.EFDAL.Entity.Customer, Acme.Northwind.EFDAL.CustomerQuery, short>.UpdateData(select, where, newValue, "Customers", GetDatabaseFieldName, true, connectionString);
		}
		...
		/// <param name="newValue">The new value to set the specified field in all matching records</param>
		/// <returns>The number of records affected</returns>
		public static int UpdateData(Expression<Func<Acme.Northwind.EFDAL.CustomerQuery, string>> select, Expression<Func<Acme.Northwind.EFDAL.CustomerQuery, bool>> where, string newValue)
		{
			return BusinessObjectQuery<Acme.Northwind.EFDAL.Entity.Customer, Acme.Northwind.EFDAL.CustomerQuery, string>.UpdateData(select, where, newValue, "Customers", GetDatabaseFieldName, true);
		}
		...
		/// <param name="connectionString">The daatbase connection string</param>
		/// <returns>The number of records affected</returns>
		public static int UpdateData(Expression<Func<Acme.Northwind.EFDAL.CustomerQuery, string>> select, Expression<Func<Acme.Northwind.EFDAL.CustomerQuery, bool>> where, string newValue, string connectionString)
		{
			return BusinessObjectQuery<Acme.Northwind.EFDAL.Entity.Customer, Acme.Northwind.EFDAL.CustomerQuery, string>.UpdateData(select, where, newValue, "Customers", GetDatabaseFieldName, true, connectionString);
		}
		...
		/// <param name="newValue">The new value to set the specified field in all matching records</param>
		/// <returns>The number of records affected</returns>
		public static int UpdateData(Expression<Func<Acme.Northwind.EFDAL.CustomerQuery, DateTime>> select, Expression<Func<Acme.Northwind.EFDAL.CustomerQuery, bool>> where, DateTime newValue)
		{
			return BusinessObjectQuery<Acme.Northwind.EFDAL.Entity.Customer, Acme.Northwind.EFDAL.CustomerQuery, DateTime>.UpdateData(select, where, newValue, "Customers", GetDatabaseFieldName, true);
		}
		...
		/// <param name="connectionString">The daatbase connection string</param>
		/// <returns>The number of records affected</returns>
		public static int UpdateData(Expression<Func<Acme.Northwind.EFDAL.CustomerQuery, DateTime>> select, Expression<Func<Acme.Northwind.EFDAL.CustomerQuery, bool>> where, DateTime newValue, string connectionString)
		{
			return BusinessObjectQuery<Acme.Northwind.EFDAL.Entity.Customer, Acme.Northwind.EFDAL.CustomerQuery, DateTime>.UpdateData(select, where, newValue, "Customers", GetDatabaseFieldName, true, connectionString);
		}
		...
		/// <param name="newValue">The new value to set the specified field in all matching records</param>
		/// <returns>The number of records affected</returns>
		public static int UpdateData(Expression<Func<Acme.Northwind.EFDAL.CustomerQuery, bool>> select, Expression<Func<Acme.Northwind.EFDAL.CustomerQuery, bool>> where, bool newValue)
		{
			return BusinessObjectQuery<Acme.Northwind.EFDAL.Entity.Customer, Acme.Northwind.EFDAL.CustomerQuery, bool>.UpdateData(select, where, newValue, "Customers", GetDatabaseFieldName, true);
		}
		...
		/// <param name="connectionString">The daatbase connection string</param>
		/// <returns>The number of records affected</returns>
		public static int UpdateData(Expression<Func<Acme.Northwind.EFDAL.CustomerQuery, bool>> select, Expression<Func<Acme.Northwind.EFDAL.CustomerQuery, bool>> where, bool newValue, string connectionString)
		{
			return BusinessObjectQuery<Acme.Northwind.EFDAL.Entity.Customer, Acme.Northwind.EFDAL.CustomerQuery, bool>.UpdateData(select, where, newValue, "Customers", GetDatabaseFieldName, true, connectionString);
		}
		...
		/// <param name="newValue">The new value to set the specified field in all matching records</param>
		/// <returns>The number of records affected</returns>
		public static int UpdateData(Expression<Func<Acme.Northwind.EFDAL.CustomerQuery, Guid>> select, Expression<Func<Acme.Northwind.EFDAL.CustomerQuery, bool>> where, Guid newValue)
		{
			return BusinessObjectQuery<Acme.Northwind.EFDAL.Entity.Customer, Acme.Northwind.EFDAL.CustomerQuery, Guid>.UpdateData(select, where, newValue, "Customers", GetDatabaseFieldName, true);
		}
		...
		/// <param name="connectionString">The daatbase connection string</param>
		/// <returns>The number of records affected</returns>
		public static int UpdateData(Expression<Func<Acme.Northwind.EFDAL.CustomerQuery, Guid>> select, Expression<Func<Acme.Northwind.EFDAL.CustomerQuery, bool>> where, Guid newValue, string connectionString)
		{
			return BusinessObjectQuery<Acme.Northwind.EFDAL.Entity.Customer, Acme.Northwind.EFDAL.CustomerQuery, Guid>.UpdateData(select, where, newValue, "Customers", GetDatabaseFieldName, true, connectionString);
		}
		...
		public static Acme.Northwind.EFDAL.Interfaces.Entity.Metadata.CustomerMetadata GetMetadata()
		{
			var a = typeof(Customer).GetCustomAttributes(typeof(System.ComponentModel.DataAnnotations.MetadataTypeAttribute), true).FirstOrDefault();
			if (a == null) return null;
			var t = ((System.ComponentModel.DataAnnotations.MetadataTypeAttribute)a).MetadataClassType;
			if (t == null) return null;
			return Activator.CreateInstance(t) as Acme.Northwind.EFDAL.Interfaces.IMetadata as Acme.Northwind.EFDAL.Interfaces.Entity.Metadata.CustomerMetadata;
		}
		...
		bool System.IEquatable<Acme.Northwind.EFDAL.Interfaces.Entity.ICustomer>.Equals(Acme.Northwind.EFDAL.Interfaces.Entity.ICustomer other)
		{
		...
		{
			var other = obj as Acme.Northwind.EFDAL.Entity.Customer;
	...
	partial class Customer : nHydrate.EFCore.DataAccess.ICreatedAudit, nHydrate.EFCore.DataAccess.IModifiedAudit, nHydrate.EFCore.DataAccess.IConcurrencyAudit
	{

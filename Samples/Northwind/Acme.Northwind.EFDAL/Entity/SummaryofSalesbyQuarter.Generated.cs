...
{
	/// <summary>
	/// The collection to hold 'SummaryofSalesbyQuarter' entities
	/// </summary>
	[EdmEntityTypeAttribute(NamespaceName = "Acme.Northwind.EFDAL.Entity", Name = "SummaryofSalesbyQuarter")]
	[Serializable]
	[DataContractAttribute(IsReference = true)]
	[nHydrate.EFCore.Attributes.FieldNameConstantsAttribute(typeof(Acme.Northwind.EFDAL.Entity.SummaryofSalesbyQuarter.FieldNameConstants))]
	[System.ComponentModel.ImmutableObject(true)]
	[System.CodeDom.Compiler.GeneratedCode("nHydrateModelGenerator", "5.1.2")]
	public partial class SummaryofSalesbyQuarter : nHydrate.EFCore.DataAccess.NHEntityObject, nHydrate.EFCore.DataAccess.IReadOnlyBusinessObject, Acme.Northwind.EFDAL.Interfaces.Entity.ISummaryofSalesbyQuarter, System.IEquatable<Acme.Northwind.EFDAL.Interfaces.Entity.ISummaryofSalesbyQuarter>
	{
		#region FieldNameConstants Enumeration

		/// <summary>
		/// Enumeration to define each property that maps to a database field for the 'SummaryofSalesbyQuarter' customView.
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the Acme.Northwind.EFDAL.Entity.SummaryofSalesbyQuarter class
		/// </summary>
		protected internal SummaryofSalesbyQuarter()
		{
		}
		...
		{
			var o = new SummaryofSalesbyQuarter();
		...
		#region Equals
		bool System.IEquatable<Acme.Northwind.EFDAL.Interfaces.Entity.ISummaryofSalesbyQuarter>.Equals(Acme.Northwind.EFDAL.Interfaces.Entity.ISummaryofSalesbyQuarter other)
		{
		...
		{
			var other = obj as Acme.Northwind.EFDAL.Entity.SummaryofSalesbyQuarter;
		...
		/// Gets the value of one of this object's properties.
		/// </summary>
		public int GetInteger(Acme.Northwind.EFDAL.Entity.SummaryofSalesbyQuarter.FieldNameConstants field)
		{
		...
		/// Gets the value of one of this object's properties.
		/// </summary>
		public int GetInteger(Acme.Northwind.EFDAL.Entity.SummaryofSalesbyQuarter.FieldNameConstants field, int defaultValue)
		{
		...
		/// Gets the value of one of this object's properties.
		/// </summary>
		public double GetDouble(Acme.Northwind.EFDAL.Entity.SummaryofSalesbyQuarter.FieldNameConstants field)
		{
		...
		/// Gets the value of one of this object's properties.
		/// </summary>
		public double GetDouble(Acme.Northwind.EFDAL.Entity.SummaryofSalesbyQuarter.FieldNameConstants field, double defaultValue)
		{
			var o = this.GetValue(field, defaultValue);
			if (o is string)
			{
		...
		/// Gets the value of one of this object's properties.
		/// </summary>
		public System.DateTime GetDateTime(Acme.Northwind.EFDAL.Entity.SummaryofSalesbyQuarter.FieldNameConstants field)
		{
		...
		/// Gets the value of one of this object's properties.
		/// </summary>
		public System.DateTime GetDateTime(Acme.Northwind.EFDAL.Entity.SummaryofSalesbyQuarter.FieldNameConstants field, System.DateTime defaultValue)
		{
			var o = this.GetValue(field, defaultValue);
			if (o is string)
			{
		...
		/// Gets the value of one of this object's properties.
		/// </summary>
		public string GetString(Acme.Northwind.EFDAL.Entity.SummaryofSalesbyQuarter.FieldNameConstants field)
		{
		...
		/// Gets the value of one of this object's properties.
		/// </summary>
		public string GetString(Acme.Northwind.EFDAL.Entity.SummaryofSalesbyQuarter.FieldNameConstants field, string defaultValue)
		{
			var o = this.GetValue(field, defaultValue);
			if (o is string)
			{
		...
		/// </summary>
		internal static string GetDatabaseFieldName(SummaryofSalesbyQuarter.FieldNameConstants field)
		{

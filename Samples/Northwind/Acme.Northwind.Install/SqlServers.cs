...
namespace Acme.Northwind.Install
{
	internal class SqlServers
	{
		...
		public static List<string> GetEmbeddedScripts(string resourceFileName, IEnumerable<string> skipSections)
		{
		...
		public static void RunEmbeddedFile(SqlConnection connection, SqlTransaction transaction, string resourceFileName, List<nHydrateDbObject> _databaseItems, List<nHydrateDbObject> _currentItems)
		{
			RunEmbeddedFile(connection, transaction, resourceFileName, null, _databaseItems, _currentItems);
		}

		public static void RunEmbeddedFile(SqlConnection connection, SqlTransaction transaction, string resourceFileName, List<KeyValuePair<Guid, string>> failedScripts, List<nHydrateDbObject> _databaseItems, List<nHydrateDbObject> _currentItems)
		{
			RunEmbeddedFile(connection, transaction, resourceFileName, failedScripts, null, null, _databaseItems, _currentItems);
		}
		...
		internal static void ExecuteSQL(SqlConnection connection, SqlTransaction transaction, string sql, List<KeyValuePair<Guid, string>> failedScripts)
		{
			ExecuteSQL(connection, transaction, sql, failedScripts, null);
		}

		internal static void ExecuteSQL(SqlConnection connection, SqlTransaction transaction, string sql, List<KeyValuePair<Guid, string>> failedScripts, List<Guid> successOrderScripts)
		{

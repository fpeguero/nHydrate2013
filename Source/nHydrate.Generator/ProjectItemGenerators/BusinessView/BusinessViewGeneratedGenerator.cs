...
{
	[GeneratorItemAttribute("BusinessViewGenerated", typeof(BusinessViewExtenderGenerator))]
	class BusinessViewGeneratedGenerator : BaseClassGenerator
	{
    ...
    public override void Generate()
      ...
      try
      {
        foreach(CustomView view in _model.Database.CustomViews)
        {
          if(view.Generated)
          {
            BusinessViewGeneratedTemplate template = new BusinessViewGeneratedTemplate(_model, view);

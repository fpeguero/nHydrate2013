...
{
	class BusinessObjectLINQExtenderTemplate : BaseClassTemplate
	{
		private StringBuilder sb = new StringBuilder();
		private Table _currentTable;

		#region Constructors
		public BusinessObjectLINQExtenderTemplate(ModelRoot model, Table currentTable)
    {
      _model = model;
      ...
      catch(Exception ex)
      {
		...
		{
			sb.AppendLine("	partial class " + _currentTable.PascalName + "Query");
			sb.AppendLine("	{");
			sb.AppendLine("	}");
		}
		#endregion

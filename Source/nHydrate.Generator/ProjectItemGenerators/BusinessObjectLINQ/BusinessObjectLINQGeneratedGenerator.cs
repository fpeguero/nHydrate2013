...
{
	[GeneratorItemAttribute("BusinessObjectLINQGenerated", typeof(BusinessObjectLINQExtenderGenerator))]
	class BusinessObjectLINQGeneratedGenerator : BaseClassGenerator
	{
    ...
    public override void Generate()
		{
			foreach (Table table in (from x in _model.Database.Tables where x.Generated orderby x.Name select x))
			{
				if (table.Generated)
				{
					BusinessObjectLINQGeneratedTemplate template = new BusinessObjectLINQGeneratedTemplate(_model, table);

...
{
	[GeneratorItemAttribute("DefinedViewSelectCommandExtender", typeof(DomainProjectGenerator))]
	class DefinedViewSelectCommandExtenderGenerator : BaseClassGenerator
	{
		#region Class Members

		private const string RELATIVE_OUTPUT_LOCATION = @"\Business\DefinedViewSelectCommands\";
    ...
    public override void Generate()
      ...
      try
      {
        foreach(CustomView view in _model.Database.CustomViews)
        {
          if(view.Generated)
          {
            DefinedViewSelectCommandExtenderTemplate template = new DefinedViewSelectCommandExtenderTemplate(_model, view);

...
{
  [GeneratorItemAttribute("DefinedStoredProcedureSelectCommandGenerated", typeof(DefinedStoredProcedureSelectCommandExtenderGenerator))]
  class DefinedStoredProcedureSelectCommandGeneratedGenerator : BaseClassGenerator
  {
    #region Class Members

    private const string RELATIVE_OUTPUT_LOCATION = @"\Business\DefinedStoredProcedureSelectCommands\";

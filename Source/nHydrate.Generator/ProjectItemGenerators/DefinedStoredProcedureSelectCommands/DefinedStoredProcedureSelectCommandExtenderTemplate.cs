...
{
	class DefinedStoredProcedureSelectCommandExtenderTemplate : BaseClassTemplate
	{
    ...
    public DefinedStoredProcedureSelectCommandExtenderTemplate(ModelRoot model, CustomStoredProcedure currentStoredProcedure)
    {
      ...
      try
      {
        sb.AppendLine("namespace " + DefaultNamespace + ".Business.DefinedStoredProcedureSelectCommands" );
        sb.AppendLine("{" );
        sb.AppendLine("}" );
      }
      catch(Exception ex)

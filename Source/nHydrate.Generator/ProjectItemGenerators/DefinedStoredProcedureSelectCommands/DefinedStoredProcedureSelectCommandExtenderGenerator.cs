...
{
	[GeneratorItemAttribute("DefinedStoredProcedureSelectCommandExtender", typeof(DomainProjectGenerator))]
	class DefinedStoredProcedureSelectCommandExtenderGenerator : BaseClassGenerator
	{

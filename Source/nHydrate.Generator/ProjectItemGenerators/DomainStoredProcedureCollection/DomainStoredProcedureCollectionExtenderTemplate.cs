...
{
	class DomainStoredProcedureCollectionExtenderTemplate : BaseClassTemplate
	{
    ...
    public DomainStoredProcedureCollectionExtenderTemplate(ModelRoot model, CustomStoredProcedure currentStoredProcedure)
    {
      ...
      catch(Exception ex)
      {
		...
		{
      sb.AppendLine("	internal partial class " + "Domain" + _currentStoredProcedure.PascalName + "Collection");
			sb.AppendLine("	{");
			sb.AppendLine("	}");
		}
		#endregion

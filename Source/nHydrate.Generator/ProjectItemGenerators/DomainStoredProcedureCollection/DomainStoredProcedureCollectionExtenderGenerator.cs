...
{
	[GeneratorItemAttribute("DomainStoredProcedureCollectionExtender", typeof(DomainProjectGenerator))]
	class DomainStoredProcedureCollectionExtenderGenerator : BaseClassGenerator
	{

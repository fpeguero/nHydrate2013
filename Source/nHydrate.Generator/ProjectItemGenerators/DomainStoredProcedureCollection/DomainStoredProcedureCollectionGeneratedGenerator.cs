...
{
	[GeneratorItemAttribute("DomainStoredProcedureCollectionGenerated", typeof(DomainStoredProcedureCollectionExtenderGenerator))]
	class DomainStoredProcedureCollectionGeneratedGenerator : BaseClassGenerator
	{
    ...
    public override void Generate()
      ...
      try
      {
        foreach (CustomStoredProcedure storedProcedure in _model.Database.CustomStoredProcedures.OrderBy(x => x.Name))
        {
          ...
          {
            DomainStoredProcedureCollectionGeneratedTemplate template = new DomainStoredProcedureCollectionGeneratedTemplate(_model, storedProcedure);

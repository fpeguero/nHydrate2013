...
{
	class UpgradeScriptTemplate : BaseDbScriptTemplate
	{
		private StringBuilder sb = new StringBuilder();

		#region Constructors
		public UpgradeScriptTemplate(ModelRoot model)
    {
      _model = model;
		}
		#endregion 
		...
		public override string FileName
		{
			get 
			{
				...
				return string.Format("{0}_{1}_{2}_{3}_UpgradeScript.sql", new object[] {major, minor, revision, build});
			}
		}
		#endregion
      ...
      try
      {
				...
				sb.AppendLine("--Upgrade For Version " + _model.Version);
				sb.AppendLine();
			}
      catch(Exception ex)
      {

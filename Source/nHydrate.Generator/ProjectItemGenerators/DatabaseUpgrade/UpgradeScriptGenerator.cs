...
{
	[GeneratorItemAttribute("UpgradeScript", typeof(DatabaseProjectGenerator))]
	public class UpgradeScriptGenerator : BaseDbScriptGenerator
	{
		#region Class Members

		private const string PARENT_ITEM_NAME = @"Upgrade Scripts";
    ...
    public override void Generate()
		{
			UpgradeScriptTemplate template = new UpgradeScriptTemplate(_model);

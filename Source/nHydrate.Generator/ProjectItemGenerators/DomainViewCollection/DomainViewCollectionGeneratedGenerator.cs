...
{
	[GeneratorItemAttribute("DomainViewCollectionGenerated", typeof(DomainViewCollectionExtenderGenerator))]
	class DomainViewCollectionGeneratedGenerator : BaseClassGenerator
	{
		#region Class Members

		private const string RELATIVE_OUTPUT_LOCATION = @"\Domain\Views\";
    ...
    public override void Generate()
      ...
      try
      {
        foreach(CustomView view in _model.Database.CustomViews)
        {
          if(view.Generated)
          {
            DomainViewCollectionGeneratedTemplate template = new DomainViewCollectionGeneratedTemplate(_model, view);

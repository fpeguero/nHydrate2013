...
{
	[GeneratorItemAttribute("BusinessObjectExtender", typeof(DomainProjectGenerator))]
	class BusinessObjectExtenderGenerator : BaseClassGenerator
	{
    ...
    public override void Generate()
        ...
        if(table.Generated)
        {
          ...
          BusinessObjectExtenderTemplate template = new BusinessObjectExtenderTemplate(_model, table);

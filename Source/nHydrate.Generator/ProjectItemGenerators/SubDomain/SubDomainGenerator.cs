...
{
	[GeneratorItemAttribute("SubDomain", typeof(DomainProjectGenerator))]
	class SubDomainGenerator : BaseClassGenerator
	{
		#region Class Members

		private const string RELATIVE_OUTPUT_LOCATION = @"\Business\";
    ...
    public override void Generate()
		{
			SubDomainTemplate template = new SubDomainTemplate(_model);

...
{
	[GeneratorItemAttribute("BusinessViewCollectionGenerated", typeof(BusinessViewCollectionExtenderGenerator))]
	class BusinessViewCollectionGeneratedGenerator : BaseClassGenerator
	{
    ...
    public override void Generate()
      ...
      try
      {
        foreach(CustomView view in _model.Database.CustomViews)
        {
          if(view.Generated)
          {
            BusinessViewCollectionGeneratedTemplate template = new BusinessViewCollectionGeneratedTemplate(_model, view);

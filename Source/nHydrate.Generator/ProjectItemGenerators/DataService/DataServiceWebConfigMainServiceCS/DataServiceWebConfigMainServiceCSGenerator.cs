...
{
	[GeneratorItemAttribute("DataServiceWebConfigMainServiceCSGenerator", typeof(DataTransferServiceProjectGenerator))]
	class DataServiceWebConfigMainServiceCSGenerator : BaseGenerator
	{

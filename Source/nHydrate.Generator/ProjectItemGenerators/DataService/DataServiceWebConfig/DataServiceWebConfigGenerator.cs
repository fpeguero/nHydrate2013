...
{
	[GeneratorItemAttribute("DataServiceWebConfigGenerator", typeof(DataTransferServiceProjectGenerator))]
	class DataServiceWebConfigGenerator : BaseGenerator
	{
    ...
    public override int FileCount
    {
      get { return _model.Database.Tables.Count; }
		...
		{
			DataServiceWebConfigTemplate template = new DataServiceWebConfigTemplate(_model);

...
{
	[GeneratorItemAttribute("DataTransferContainerExtender", typeof(DataTransferServiceProjectGenerator))]
	class DataServiceWebConfigMainServiceASMXGenerator : BaseGenerator
	{
    ...
    public override int FileCount
    {
      get { return _model.Database.Tables.Count; }
		...
		{
			DataServiceWebConfigMainServiceASMXTemplate template = new DataServiceWebConfigMainServiceASMXTemplate(_model);

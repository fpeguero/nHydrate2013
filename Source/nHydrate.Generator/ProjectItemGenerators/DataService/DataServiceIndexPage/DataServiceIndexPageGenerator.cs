...
{
	[GeneratorItemAttribute("DataServiceIndexPageGenerator", typeof(DataTransferServiceProjectGenerator))]
	class DataServiceIndexPageGenerator : BaseGenerator
	{
    ...
    public override int FileCount
    {
      get { return _model.Database.Tables.Count; }
		...
		{
			DataServiceIndexPageTemplate template = new DataServiceIndexPageTemplate(_model);

...
{
	[GeneratorItemAttribute("ObjectGridJSGenerator", typeof(DataTransferServiceProjectGenerator))]
	class ObjectGridJSGenerator : BaseGenerator
	{
		#region Class Members

		private const string RELATIVE_OUTPUT_LOCATION = @"\scripts\generated\grid\";

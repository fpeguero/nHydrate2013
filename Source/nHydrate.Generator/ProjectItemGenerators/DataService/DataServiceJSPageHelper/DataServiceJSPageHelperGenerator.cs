...
{
	[GeneratorItemAttribute("DataServiceJSPageHelperGenerator", typeof(DataTransferServiceProjectGenerator))]
	class DataServiceJSPageHelperGenerator : BaseGenerator
	{
		#region Class Members

		private const string RELATIVE_OUTPUT_LOCATION = @"\scripts\generated\";
    ...
    public override int FileCount
    {
      get { return _model.Database.Tables.Count; }
		...
		{
			DataServiceJSPageHelperTemplate template = new DataServiceJSPageHelperTemplate(_model);

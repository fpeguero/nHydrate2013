...
{
	[GeneratorItemAttribute("DataServiceGlobalModuleASAXGenerator", typeof(DataTransferServiceProjectGenerator))]
	class DataServiceGlobalModuleASAXGenerator : BaseGenerator
	{
    ...
    public override int FileCount
    {
      get { return _model.Database.Tables.Count; }
		...
		{
			DataServiceGlobalModuleASAXTemplate template = new DataServiceGlobalModuleASAXTemplate(_model);

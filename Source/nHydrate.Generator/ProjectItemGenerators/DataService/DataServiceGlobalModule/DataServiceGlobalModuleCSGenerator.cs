...
{
	[GeneratorItemAttribute("DataServiceGlobalModuleCSGenerator", typeof(DataTransferServiceProjectGenerator))]
	class DataServiceGlobalModuleCSGenerator : BaseGenerator
	{
    ...
    public override int FileCount
    {
      get { return _model.Database.Tables.Count; }
		...
		{
			DataServiceGlobalModuleCSTemplate template = new DataServiceGlobalModuleCSTemplate(_model);

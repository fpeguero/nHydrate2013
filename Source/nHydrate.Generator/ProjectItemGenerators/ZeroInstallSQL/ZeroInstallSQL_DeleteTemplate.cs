...
{
	class ZeroInstallSQL_DeleteTemplate : BaseDbScriptTemplate
	{
		...
		public ZeroInstallSQL_DeleteTemplate(ModelRoot model, Table currentTable)
		{
			_model = model;
		...
		{
			get { return string.Format("gen_{0}Delete.sql", _currentTable.PascalName); }
		}

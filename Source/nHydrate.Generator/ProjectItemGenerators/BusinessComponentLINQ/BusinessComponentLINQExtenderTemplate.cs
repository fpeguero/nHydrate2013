...
{
	class BusinessComponentLINQExtenderTemplate : BaseClassTemplate
	{
		private StringBuilder sb = new StringBuilder();
		private TableComponent _currentComponent;

		#region Constructors
		public BusinessComponentLINQExtenderTemplate(ModelRoot model, TableComponent currentComponent)
    {
      _model = model;
      ...
      catch(Exception ex)
      {
		...
		{
			sb.AppendLine("	partial class " + _currentComponent.PascalName + "Query");
			sb.AppendLine("	{");
			sb.AppendLine("	}");
		}
		#endregion

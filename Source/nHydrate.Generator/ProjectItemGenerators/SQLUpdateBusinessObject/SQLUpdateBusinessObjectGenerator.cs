...
{
	[GeneratorItemAttribute("SqlUpdate", typeof(DatabaseProjectGenerator))]
	class SQLUpdateBusinessObjectGenerator : BaseDbScriptGenerator
	{
		#region Class Members

		private const string PARENT_ITEM_NAME = @"Stored Procedures\Generated\Update";
    ...
    public override void Generate()
        ...
        if(table.Generated)
        {
					...
					{
						SQLUpdateBusinessObjectTemplate template = new SQLUpdateBusinessObjectTemplate(_model, table);

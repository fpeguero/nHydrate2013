...
{
	class DomainComponentCollectionExtenderTemplate : BaseClassTemplate
	{
		...
		public DomainComponentCollectionExtenderTemplate(ModelRoot model, TableComponent currentComponent)
    {
      ...
      _currentComponent = currentComponent;
		...
		public override string FileName
		{
			get 
			{
				return string.Format("Domain{0}Collection.cs", _currentComponent.PascalName);
			}
		}
		#endregion
      ...
      catch(Exception ex)
      {
		...
		{
      sb.AppendLine("	internal partial class " + "Domain" + _currentComponent.PascalName + "Collection");
			sb.AppendLine("	{");
			sb.AppendLine("	}");
		}
		#endregion

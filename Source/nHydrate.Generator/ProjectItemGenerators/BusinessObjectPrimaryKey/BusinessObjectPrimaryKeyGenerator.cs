...
{
	[GeneratorItemAttribute("primaryKey", typeof(DomainProjectGenerator))]
	class PrimaryKeyGenerator : BaseClassGenerator
	{
    ...
    public override void Generate()
        ...
        if(table.Generated)
        {
          PrimaryKeyTemplate template = new PrimaryKeyTemplate(_model, table);

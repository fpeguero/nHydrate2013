...
{
	class DomainComponentExtenderTemplate : BaseClassTemplate
	{
		private StringBuilder sb = new StringBuilder();
		private TableComponent _currentComponent;

		#region Constructors
		public DomainComponentExtenderTemplate(ModelRoot model, TableComponent currentComponent)
    {
      _model = model;
      ...
      catch(Exception ex)
      {
		...
		{
      sb.AppendLine("	internal partial class " + "Domain" + _currentComponent.PascalName);
			sb.AppendLine("	{");
			sb.AppendLine("	}");
		}
		#endregion

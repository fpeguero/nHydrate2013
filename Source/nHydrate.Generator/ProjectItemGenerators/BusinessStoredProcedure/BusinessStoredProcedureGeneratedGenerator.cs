...
{
	[GeneratorItemAttribute("BusinessStoredProcedureGenerated", typeof(BusinessStoredProcedureExtenderGenerator))]
	class BusinessStoredProcedureGeneratedGenerator : BaseClassGenerator
	{

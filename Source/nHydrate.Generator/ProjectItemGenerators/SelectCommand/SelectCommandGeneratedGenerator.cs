...
{
	[GeneratorItemAttribute("SelectCommandGenerated", typeof(SelectCommandExtenderGenerator))]
	class SelectCommandGeneratedGenerator : BaseClassGenerator
	{
    ...
    public override void Generate()
      ...
      try
      {
        foreach(Table table in _model.Database.Tables)
        {
          if(table.Generated)
          {
            SelectCommandGeneratedTemplate template = new SelectCommandGeneratedTemplate(_model, table);

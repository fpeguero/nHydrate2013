...
{
	[GeneratorItemAttribute("BusinessComponentGenerated", typeof(BusinessComponentExtenderGenerator))]
	class BusinessComponentGeneratedGenerator : BaseClassGenerator
	{
    ...
    public override void Generate()
		{
			foreach (Table table in (from x in _model.Database.Tables where x.Generated orderby x.Name select x))
			{
				if (table.Generated)
				{
					...
					{
						BusinessComponentGeneratedTemplate template = new BusinessComponentGeneratedTemplate(_model, component);

...
{
	[GeneratorItemAttribute("BusinessComponentCollectionExtender", typeof(DomainProjectGenerator))]
	class BusinessComponentCollectionExtenderGenerator : BaseClassGenerator
	{
    ...
    public override void Generate()
        ...
        if(table.Generated)
        {
					...
					{
						BusinessComponentCollectionExtenderTemplate template = new BusinessComponentCollectionExtenderTemplate(_model, component);

...
{
  [GeneratorItemAttribute("DomainStoredProcedureExtenderTemplate", typeof(DomainProjectGenerator))]
	class DomainStoredProcedureExtenderGenerator : BaseClassGenerator
	{
    ...
    public override void Generate()
      ...
      try
      {
        foreach (CustomStoredProcedure storedProcedure in _model.Database.CustomStoredProcedures.OrderBy(x => x.Name))
        {
          ...
          {
            DomainStoredProcedureExtenderTemplate template = new DomainStoredProcedureExtenderTemplate(_model, storedProcedure);

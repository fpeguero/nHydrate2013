...
{
	[GeneratorItemAttribute("BusinessStoredProcedureCollectionExtender", typeof(DomainProjectGenerator))]
	class BusinessStoredProcedureCollectionExtenderGenerator : BaseClassGenerator
	{
    ...
    public override void Generate()
      ...
      {				
        foreach (CustomStoredProcedure storedProcedure in _model.Database.CustomStoredProcedures.OrderBy(x => x.Name))
        {
          ...
          {
            BusinessStoredProcedureCollectionExtenderTemplate template = new BusinessStoredProcedureCollectionExtenderTemplate(_model, storedProcedure);

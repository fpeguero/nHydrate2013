...
{
	[GeneratorItemAttribute("BusinessStoredProcedureCollectionGenerated", typeof(BusinessStoredProcedureCollectionExtenderGenerator))]
	class BusinessStoredProcedureCollectionGeneratedGenerator : BaseClassGenerator
	{

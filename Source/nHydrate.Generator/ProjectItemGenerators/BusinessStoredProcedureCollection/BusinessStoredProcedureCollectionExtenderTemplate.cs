...
{
	class BusinessStoredProcedureCollectionExtenderTemplate : BaseClassTemplate
	{
    ...
    public BusinessStoredProcedureCollectionExtenderTemplate(ModelRoot model, CustomStoredProcedure currentStoredProcedure)
    {
      ...
      _currentStoredProcedure = currentStoredProcedure;
		...
		public override string FileName
		{
			get 
			{
        return string.Format("{0}Collection.cs", _currentStoredProcedure.PascalName);
			}
		}
		#endregion
      ...
      catch(Exception ex)
      {
		...
		{
      sb.AppendLine("	partial class " + _currentStoredProcedure.PascalName + "Collection");
			sb.AppendLine("	{");
			sb.AppendLine("	}");
		}
		#endregion

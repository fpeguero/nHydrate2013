...
{
  [GeneratorItemAttribute("DomainViewGeneratedTemplate", typeof(DomainViewExtenderGenerator))]
	class DomainViewGeneratedGenerator : BaseClassGenerator
	{
    ...
    public override void Generate()
      ...
      try
      {
        foreach(CustomView view in _model.Database.CustomViews)
        {
          if(view.Generated)
          {
            DomainViewGeneratedTemplate template = new DomainViewGeneratedTemplate(_model, view);

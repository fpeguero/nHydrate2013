...
{
  [GeneratorItemAttribute("DomainViewExtenderTemplate", typeof(DomainProjectGenerator))]
	class DomainViewExtenderGenerator : BaseClassGenerator
	{
    ...
    public override void Generate()
      ...
      {				
				foreach (CustomView view in _model.Database.CustomViews.OrderBy(x => x.Name))
        {
          if(view.Generated)
          {
            DomainViewExtenderTemplate template = new DomainViewExtenderTemplate(_model, view);

...
{
	public class ColumnCollectionForm : CollectionEditorForm
	{
		private readonly System.ComponentModel.Container components = null;

		public ColumnCollectionForm()
		{
			InitializeComponent();
		}
		...
		private void InitializeComponent()
		{
			...
			// 
			// ColumnCollectionForm
			// 
			this.CancelButton = this.cmdCancel;
			this.ClientSize = new System.Drawing.Size(558, 398);
			this.Name = "ColumnCollectionForm";
			this.Text = "ColumnCollectionForm";
			this.WindowTitle = "ColumnCollectionForm";

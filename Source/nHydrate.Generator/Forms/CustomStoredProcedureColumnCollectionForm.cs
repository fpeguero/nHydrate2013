...
{
	public class CustomStoredProcedureColumnCollectionForm : CollectionEditorForm
	{
		private System.ComponentModel.Container components = null;

		public CustomStoredProcedureColumnCollectionForm()
		{
			InitializeComponent();
		}
		...
		private void InitializeComponent()
		{
			...
			// 
			// CustomStoredProcedureColumnCollectionForm
			// 
			this.CancelButton = this.cmdCancel;
			this.ClientSize = new System.Drawing.Size(558, 398);
			this.Name = "CustomStoredProcedureColumnCollectionForm";
			this.Text = "CustomStoredProcedureColumnCollectionForm";
			this.WindowTitle = "CustomStoredProcedureColumnCollectionForm";

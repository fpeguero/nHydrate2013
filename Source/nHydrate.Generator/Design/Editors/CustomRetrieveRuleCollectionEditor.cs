...
{
  internal class CustomRetrieveRuleCollectionEditor : System.Drawing.Design.UITypeEditor
  {
    public CustomRetrieveRuleCollectionEditor()
    {
    }
    ...
    public override object EditValue(ITypeDescriptorContext context, IServiceProvider provider, object value)
    {
      try
      {
        ...
        Widgetsphere.Generator.Forms.CustomRetrieveRuleReferenceCollectionForm F = new Widgetsphere.Generator.Forms.CustomRetrieveRuleReferenceCollectionForm((ReferenceCollection)value);

...
{
	public class CustomRetrieveRuleNode : ModelObjectTreeNode
	{
		#region Member Variables

		protected ModelObjectTreeNode mParameterCollectionNode = null;

		#endregion

		#region Constructor

		public CustomRetrieveRuleNode(CustomRetrieveRuleController controller)
			: base(controller)
		{
		}

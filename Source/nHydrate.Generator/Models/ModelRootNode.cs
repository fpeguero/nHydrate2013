...
{
	public class ModelRootNode : ModelObjectTreeNode
	{
		#region Member Variables

		protected ModelObjectTreeNode _databaseNode = null;
		protected ModelObjectTreeNode _userInterfaceNode = null;

		#endregion

		#region Constructor

		public ModelRootNode(ModelRootController controller)
			: base(controller)
		{
		}

...
{
	public class RelationNode : ModelObjectTreeNode
	{
		...
		public override void Refresh()
		{
			...
			this.Text = ((Relation)this.Object).ChildTable.Name;
			this.Name = ((Relation)this.Object).Key;
			this.ImageIndex = ImageHelper.GetImageIndex(TreeIconConstants.Relationship);

...
{
	public class ReferenceController : BaseModelObjectController
	{
		...
		protected internal ReferenceController(INHydrateModelObject modelObject)
			: base(modelObject)
		{
		}

...
{
	public class PackageController : BaseModelObjectController
	{
		...
		protected internal PackageController(INHydrateModelObject modelObject)
			: base(modelObject)
		{
		}
		...
		{
			if (MessageBox.Show("Do you wish to delete this package?", "Delete?", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
			{
				((ModelRoot)this.Object.Root).UserInterface.Packages.Remove(((Package)this.Object).Id);
				this.Node.Remove();

...
{
	public class TableCompositeNode : ModelObjectTreeNode
	{
		...
		public override void Refresh()
		{
			try
			{
				...
				var TableComposite = ((TableComposite)this.Object);

				this.Text = TableComposite.ToString();
				this.Name = TableComposite.Key;

				this.SelectedImageIndex = this.ImageIndex;

				if ((TableComposite.Columns != null) && (mColumnCollectionNode == null))
				{
					var element = new ColumnCollectionController(TableComposite.Columns);
				...
				if (this.Parent != null)
					((TableCompositeCollectionNode)this.Parent).Refresh();
			}
			catch (Exception ex)
			{
				throw;

...
{
	public class PackageNode : ModelObjectTreeNode
	{
		...
		public override void Refresh()
		{
			...
			this.Text = package.ToString();
			this.Name = package.Key;
			this.ImageIndex = ImageHelper.GetImageIndex(TreeIconConstants.Package);
			this.SelectedImageIndex = this.ImageIndex;
			this.ToolTipText = package.Description;

			if (this.Parent != null)
				((PackageCollectionNode)this.Parent).Refresh();

...
{
	[GeneratorItemAttribute("PagingBaseExtender", typeof(EFDALProjectGenerator))]
	class PagingBaseExtenderGenerator : BaseClassGenerator
	{
		...
		{
			PagingBaseExtenderTemplate template = new PagingBaseExtenderTemplate(_model);

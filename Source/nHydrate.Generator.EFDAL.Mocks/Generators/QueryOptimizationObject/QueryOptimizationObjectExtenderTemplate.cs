...
{
	class QueryOptimizationObjectExtenderTemplate : EFDALBaseTemplate
	{
		private StringBuilder sb = new StringBuilder();

		#region Constructors
		public QueryOptimizationObjectExtenderTemplate(ModelRoot model)
		{
			_model = model;
		}
		#endregion
		...
		{
			sb.AppendLine("	partial class QueryOptimizer");
			sb.AppendLine("	{");
			sb.AppendLine("	}");
		}
		#endregion

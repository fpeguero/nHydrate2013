...
{
	[GeneratorItemAttribute("QueryOptimizationObjectExtender", typeof(EFDALProjectGenerator))]
	class QueryOptimizationObjectExtenderGenerator : BaseClassGenerator
	{
		...
		{
			QueryOptimizationObjectExtenderTemplate template = new QueryOptimizationObjectExtenderTemplate(_model);

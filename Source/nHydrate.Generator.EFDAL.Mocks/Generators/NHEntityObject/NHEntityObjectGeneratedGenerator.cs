...
{
	[GeneratorItemAttribute("NHEntityObjectGeneratedGenerator", typeof(NHEntityObjectExtenderGenerator))]
	public class NHEntityObjectGeneratedGenerator : BaseClassGenerator
	{
		...
		{
			NHEntityObjectGeneratedTemplate template = new NHEntityObjectGeneratedTemplate(_model);

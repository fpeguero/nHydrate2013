...
{
	[GeneratorItemAttribute("NHEntityObjectExtenderGenerator", typeof(EFDALProjectGenerator))]
	public class NHEntityObjectExtenderGenerator : BaseClassGenerator
	{
		...
		{
			NHEntityObjectExtenderTemplate template = new NHEntityObjectExtenderTemplate(_model);

...
{
	[GeneratorItem("ServiceWebConfigGenerator", typeof(WCFServiceProjectGenerator))]
	class ServiceWebConfigGenerator : BaseProjectItemGenerator
	{
		...
		{
			var template = new ServiceWebConfigTemplate(_model);

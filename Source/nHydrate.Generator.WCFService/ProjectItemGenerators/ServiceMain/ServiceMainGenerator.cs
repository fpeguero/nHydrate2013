...
{
	[GeneratorItem("ServiceMainGenerator", typeof(WCFServiceProjectGenerator))]
	class ServiceMainGenerator : BaseProjectItemGenerator
	{
		...
		{
			var template = new ServiceMainTemplate(_model);

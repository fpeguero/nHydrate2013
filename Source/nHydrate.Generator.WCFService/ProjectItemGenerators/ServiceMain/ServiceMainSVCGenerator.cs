...
{
	[GeneratorItem("ServiceMainSVCGenerator", typeof(WCFServiceProjectGenerator))]
	class ServiceMainSVCGenerator : BaseProjectItemGenerator
	{
		...
		{
			var template = new ServiceMainSVCTemplate(_model);

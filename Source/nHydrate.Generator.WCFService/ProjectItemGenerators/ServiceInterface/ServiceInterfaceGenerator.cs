...
{
	[GeneratorItem("ServiceInterfaceGenerator", typeof(WCFServiceProjectGenerator))]
	class ServiceInterfaceGenerator : BaseProjectItemGenerator
	{
		...
		{
			var template = new ServiceInterfaceTemplate(_model);

...
{
	[GeneratorItem("DataServiceGlobalModuleASAXGenerator", typeof(WCFServiceProjectGenerator))]
	class DataServiceGlobalModuleASAXGenerator : BaseProjectItemGenerator
	{
		...
		{
			var template = new DataServiceGlobalModuleASAXTemplate(_model);

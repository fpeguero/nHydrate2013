...
{
	class IncludeTreeLINQExtenderTemplate : EFCodeFirstBaseTemplate
	{
		private StringBuilder sb = new StringBuilder();
		private Table _currentTable;

		#region Constructors
		public IncludeTreeLINQExtenderTemplate(ModelRoot model, Table currentTable)
		{
			_model = model;
		...
		public override string FileName
		{
			get 
			{
				return string.Format("{0}Include.cs", _currentTable.PascalName);
			}
		}
		#endregion

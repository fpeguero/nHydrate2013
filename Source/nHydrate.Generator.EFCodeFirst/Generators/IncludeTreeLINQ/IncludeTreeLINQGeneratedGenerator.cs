...
{
	[GeneratorItemAttribute("IncludeTreeLINQGenerated", typeof(IncludeTreeLINQExtenderGenerator))]
	class IncludeTreeLINQGeneratedGenerator : EFCodeFirstProjectItemGenerator
	{
		...
		public override void Generate()
		{
			foreach (Table table in _model.Database.Tables.Where(x => x.Generated).OrderBy(x => x.Name))
			{
				if (table.Generated)
				{
					IncludeTreeLINQGeneratedTemplate template = new IncludeTreeLINQGeneratedTemplate(_model, table);

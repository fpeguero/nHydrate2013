...
{
	class LINQExtenderTemplate : EFCodeFirstBaseTemplate
	{
		private StringBuilder sb = new StringBuilder();
		private Table _currentTable;

		#region Constructors
		public LINQExtenderTemplate(ModelRoot model, Table currentTable)
		{
			_model = model;
		...
		public override string FileName
		{
			get 
			{
				return string.Format("{0}Query.cs", _currentTable.PascalName);
			}
		}
		#endregion

...
{
	[GeneratorItemAttribute("ContextStartupExtenderGenerator", typeof(EFCodeFirstProjectGenerator))]
	public class ContextStartupExtenderGenerator : EFCodeFirstProjectItemGenerator
	{

...
{
	[GeneratorItemAttribute("AuditEntityGeneratedGenerator", typeof(AuditEntityExtenderGenerator))]
	public class AuditEntityGeneratedGenerator : EFCodeFirstProjectItemGenerator
	{
		...
		public override void Generate()
		{
			...
			{
				AuditEntityGeneratedTemplate template = new AuditEntityGeneratedTemplate(_model, table);

...
{
	[GeneratorItemAttribute("ContextExtenderGenerator", typeof(EFCodeFirstProjectGenerator))]
	public class ContextExtenderGenerator : EFCodeFirstProjectItemGenerator
	{

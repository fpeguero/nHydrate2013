...
{
	[GeneratorItemAttribute("ContextGeneratedGenerator", typeof(ContextExtenderGenerator))]
	public class ContextGeneratedGenerator : EFCodeFirstProjectItemGenerator
	{

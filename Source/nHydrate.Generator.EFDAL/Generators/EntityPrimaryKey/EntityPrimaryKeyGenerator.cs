...
{
	[GeneratorItem("EntityPrimaryKeyGenerator", typeof(EntityPrimaryKeyExtenderGenerator))]
	class EntityPrimaryKeyGenerator : EFDALProjectItemGenerator
	{
		...
		public override void Generate()
		{
			...
			{
				var fullFileName = RELATIVE_OUTPUT_LOCATION + string.Format("{0}PrimaryKey.Generated.cs", name);

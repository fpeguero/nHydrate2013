...
{
	[GeneratorItemAttribute("QueryOptimizationObjectGenerated", typeof(QueryOptimizationObjectExtenderGenerator))]
	class QueryOptimizationObjectGeneratedGenerator : BaseClassGenerator
	{
		...
		{
			QueryOptimizationObjectGeneratedTemplate template = new QueryOptimizationObjectGeneratedTemplate(_model);
		...
		protected override string ProjectName
		{
			get
			{
				...
				return string.Format("{1}.{0}.EFDAL", modelRoot.ProjectName, modelRoot.CompanyName);
			}
		}

...
{
	[GeneratorItemAttribute("PagingBaseGenerated", typeof(PagingBaseExtenderGenerator))]
	class PagingBaseGeneratedGenerator : BaseClassGenerator
	{
		...
		{
			PagingBaseGeneratedTemplate template = new PagingBaseGeneratedTemplate(_model);

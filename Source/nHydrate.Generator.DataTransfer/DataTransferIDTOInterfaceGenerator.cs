...
{
	[GeneratorItem("DataTransferIDTOInterface", typeof(DataTransferIDTOInterfaceExtenderGenerator))]
	class DataTransferIDTOInterfaceGenerator : BaseProjectItemGenerator
	{
		...
		{
			var template = new DataTransferIDTOInterfaceTemplate(_model);

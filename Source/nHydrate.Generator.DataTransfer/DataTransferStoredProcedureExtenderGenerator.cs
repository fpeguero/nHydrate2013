...
{
	[GeneratorItemAttribute("DaatTransferStoredProcedureExtender", typeof(DataTransferProjectGenerator))]
	class DaatTransferStoredProcedureExtenderGenerator : BaseGenerator
	{
    ...
    public override void Generate()
		{
			...
			{
				DaatTransferStoredProcedureExtenderTemplate template = new DaatTransferStoredProcedureExtenderTemplate(_model, item);

...
{
	[GeneratorItemAttribute("DaatTransferStoredProcedureGenerated", typeof(DaatTransferStoredProcedureExtenderGenerator))]
	public class DaatTransferStoredProcedureGeneratedGenerator : BaseGenerator
	{
    ...
    public override void Generate()
		{
			foreach (CustomStoredProcedure item in (from x in _model.Database.CustomStoredProcedures where x.Generated orderby x.Name select x))
			{
				DaatTransferStoredProcedureGeneratedTemplate template = new DaatTransferStoredProcedureGeneratedTemplate(_model, item);

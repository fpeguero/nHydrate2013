...
{
	[GeneratorItemAttribute("DataTransferViewGenerated", typeof(DataTransferViewExtenderGenerator))]
	public class DataTransferViewGeneratedGenerator : BaseGenerator
	{
    ...
    public override void Generate()
		{
			foreach (CustomView item in (from x in _model.Database.CustomViews where x.Generated orderby x.Name select x))
			{
				DataTransferViewGeneratedTemplate template = new DataTransferViewGeneratedTemplate(_model, item);

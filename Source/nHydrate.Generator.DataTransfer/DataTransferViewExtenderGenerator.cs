...
{
	[GeneratorItemAttribute("DataTransferViewExtender", typeof(DataTransferProjectGenerator))]
	class DataTransferViewExtenderGenerator : BaseGenerator
	{
    ...
    public override void Generate()
		{
			...
			{
				DataTransferViewExtenderTemplate template = new DataTransferViewExtenderTemplate(_model, item);

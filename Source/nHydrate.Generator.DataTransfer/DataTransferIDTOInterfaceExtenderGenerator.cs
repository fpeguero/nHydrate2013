...
{
	[GeneratorItem("DataTransferIDTOInterfaceExtenderGenerator", typeof(DataTransferProjectGenerator))]
	class DataTransferIDTOInterfaceExtenderGenerator : BaseProjectItemGenerator
	{
		...
		{
			var template = new DataTransferIDTOInterfaceExtenderTemplate(_model);

...
{
	[GeneratorItem("ProxyFactoryGenerator", typeof(ProxyFactoryExtenderGenerator))]
	class ProxyFactoryGenerator : BaseProjectItemGenerator
	{
		...
		{
			var template = new ProxyFactoryTemplate(_model);

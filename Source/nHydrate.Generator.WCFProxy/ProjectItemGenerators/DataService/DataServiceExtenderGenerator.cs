...
{
	[GeneratorItem("DataServiceExtenderGenerator", typeof(WCFProxyProjectGenerator))]
	class DataServiceExtenderGenerator : BaseProjectItemGenerator
	{
		...
		{
			var template = new DataServiceExtenderTemplate(_model);

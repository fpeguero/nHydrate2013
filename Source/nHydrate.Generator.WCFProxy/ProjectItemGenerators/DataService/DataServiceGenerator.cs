...
{
	[GeneratorItem("DataServiceGenerator", typeof(DataServiceExtenderGenerator))]
	class DataServiceGenerator : BaseProjectItemGenerator
	{
		...
		{
			var template = new DataServiceTemplate(_model);

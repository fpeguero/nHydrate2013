...
namespace Widgetsphere.Generator.MockProxy
{
	[GeneratorProjectAttribute(
		"Mock Proxy",
		"",
		"b8bd6b27-b9f2-4291-82e8-88e1295eef11",
		typeof(WidgetsphereGeneratorProject),
		typeof(MockProxyProjectGenerator),
		new string[] { 
	...
	public class MockProxyProjectGenerator : BaseProjectGenerator
	{
		protected override string ProjectTemplate
		{
			get
			{
				//GenerateCompanySpecificFile("mockproxy.csproj");
				//GenerateCompanySpecificFile("mockproxy.vstemplate");
				//return string.Format("{0}mockproxy.vstemplate", ((ModelRoot)_model).CompanyName);
				return "mockproxy.vstemplate";
			}
		}

...
{
	[GeneratorItem("ObjectServiceGenerator", typeof(ObjectServiceExtenderGenerator))]
	class ObjectServiceGenerator : BaseProjectItemGenerator
	{
		...
		public override void Generate()
		{
			...
			{
				var template = new ObjectServiceTemplate(_model, table);
				...
				var eventArgs = new ProjectItemGeneratedEventArgs(fullFileName, template.FileContent, ProjectName, fullParentName, this, true);

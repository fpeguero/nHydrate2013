...
{
	[GeneratorItem("EventArgsExtenderGenerator", typeof(MockProxyProjectGenerator))]
	class EventArgsExtenderGenerator : BaseProjectItemGenerator
	{
		#region Class Members

		private const string RELATIVE_OUTPUT_LOCATION = @"\EventArgs\";
		...
		public override void Generate()
		{
			...
			{
				var template = new EventArgsExtenderTemplate(_model, table);

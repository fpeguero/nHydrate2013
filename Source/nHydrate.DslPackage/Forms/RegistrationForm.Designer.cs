namespace nHydrate.DslPackage.Forms
{
	partial class RegistrationForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.optLogin = new System.Windows.Forms.RadioButton();
			...
			this.cmdOK.Location = new System.Drawing.Point(316, 290);
			...
			this.cmdCancel.Location = new System.Drawing.Point(341, 570);
			...
			this.txtCity.Location = new System.Drawing.Point(104, 100);
			...
			this.txtEmail.Location = new System.Drawing.Point(104, 205);
			...
			this.txtPostalCode.Location = new System.Drawing.Point(104, 152);
			this.txtPostalCode.Name = "txtPostalCode";
			this.txtPostalCode.Size = new System.Drawing.Size(288, 20);
			...
			this.txtRegion.Location = new System.Drawing.Point(104, 126);
			this.txtRegion.Name = "txtRegion";
			this.txtRegion.Size = new System.Drawing.Size(288, 20);
			...
			this.cboCountry.Location = new System.Drawing.Point(104, 176);
			...
			this.txtPassword.Location = new System.Drawing.Point(104, 231);
			...
			this.txtVerify.Location = new System.Drawing.Point(104, 257);
			this.txtVerify.Name = "txtVerify";
			this.txtVerify.Size = new System.Drawing.Size(288, 20);
			...
			this.label10.Text = "Register for a FREE nHydrate key.";
			this.label10.TextAlign = System.Drawing.ContentAlignment.TopCenter;
			// 
			// grpRegister
			// 
			this.grpRegister.Anchor = ((System.Windows.Forms.AnchorStyles)((((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom) 
            | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
			this.grpRegister.Controls.Add(this.label1);
			this.grpRegister.Controls.Add(this.txtFirstName);
			this.grpRegister.Controls.Add(this.cboCountry);
			this.grpRegister.Controls.Add(this.label2);
			this.grpRegister.Controls.Add(this.label10);
			this.grpRegister.Controls.Add(this.cmdOK);
			this.grpRegister.Controls.Add(this.txtVerify);
			...
			this.grpRegister.Controls.Add(this.txtRegion);
			this.grpRegister.Controls.Add(this.label4);
			this.grpRegister.Controls.Add(this.label5);
			this.grpRegister.Controls.Add(this.txtPostalCode);
			this.grpRegister.Controls.Add(this.label7);
			this.grpRegister.Location = new System.Drawing.Point(11, 104);
			this.grpRegister.Name = "grpRegister";
			this.grpRegister.Size = new System.Drawing.Size(405, 325);
			this.grpRegister.TabIndex = 15;
			...
			this.label13.Location = new System.Drawing.Point(101, 290);
			this.label13.Name = "label13";
			this.label13.Size = new System.Drawing.Size(107, 13);
			this.label13.TabIndex = 11;
			this.label13.Text = "* Required parameter";
			// 
			// grpLogin
			// 
            ...
            | System.Windows.Forms.AnchorStyles.Right)));
			this.grpLogin.Controls.Add(this.radioButton2);
			...
			this.cmdLogin.Location = new System.Drawing.Point(299, 79);
			...
			this.txtLoginPassword.Location = new System.Drawing.Point(103, 53);
			this.txtLoginPassword.Name = "txtLoginPassword";
			this.txtLoginPassword.Size = new System.Drawing.Size(271, 20);
			this.txtLoginPassword.TabIndex = 19;
			...
			this.txtLoginEMail.Location = new System.Drawing.Point(103, 27);
			this.txtLoginEMail.Name = "txtLoginEMail";
			this.txtLoginEMail.Size = new System.Drawing.Size(271, 20);
			this.txtLoginEMail.TabIndex = 18;
			// 
			// label12
			// 
			...
			this.pictureBox2.Location = new System.Drawing.Point(158, 551);
			...
			this.chkStat.Location = new System.Drawing.Point(112, 523);
			this.chkStat.Name = "chkStat";
			this.chkStat.Size = new System.Drawing.Size(287, 17);
			this.chkStat.TabIndex = 10;
			...
			this.optRegistration.Location = new System.Drawing.Point(12, 91);
			this.optRegistration.Name = "optRegistration";
			this.optRegistration.Size = new System.Drawing.Size(81, 17);
			this.optRegistration.TabIndex = 23;
			this.optRegistration.TabStop = true;
			this.optRegistration.Text = "Registration";
			this.optRegistration.UseVisualStyleBackColor = true;
			this.optRegistration.CheckedChanged += new System.EventHandler(this.optRegistration_CheckedChanged);
			// 
			// optLogin
			// 
			this.optLogin.AutoSize = true;
			this.optLogin.Location = new System.Drawing.Point(115, 91);
			this.optLogin.Name = "optLogin";
			this.optLogin.Size = new System.Drawing.Size(51, 17);
			this.optLogin.TabIndex = 24;
			this.optLogin.Text = "Login";
			this.optLogin.UseVisualStyleBackColor = true;
			this.optLogin.CheckedChanged += new System.EventHandler(this.optLogin_CheckedChanged);
			// 
			// panel1
			// 
			...
			this.panel1.Controls.Add(this.txtPremium);
			...
			this.label15.Size = new System.Drawing.Size(384, 27);
			this.label15.TabIndex = 9;
			this.label15.Text = "If you have a premium key for expanded functionality, enter it here. This will ac" +
    "tivate the designer for premium functionality.";
			// 
			// label14
			// 
			...
			this.label14.Text = "Premium Key:";
			// 
			// txtPremium
			// 
			this.txtPremium.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
			this.txtPremium.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
			this.txtPremium.Location = new System.Drawing.Point(96, 43);
			this.txtPremium.Name = "txtPremium";
			this.txtPremium.Size = new System.Drawing.Size(299, 20);
			this.txtPremium.TabIndex = 8;
			this.txtPremium.UseSystemPasswordChar = true;
			// 
			// RegistrationForm
			// 
			...
			this.ClientSize = new System.Drawing.Size(428, 601);
			this.Controls.Add(this.panel1);
			this.Controls.Add(this.optLogin);
			this.Controls.Add(this.optRegistration);
		...
		private System.Windows.Forms.RadioButton optLogin;

...
namespace nHydrate.DslPackage
{
	...
	/// </summary>
	internal partial class nHydrateDocView : nHydrateDocViewBase
	{
		/// <summary>
	...
	/// </summary>
	internal abstract class nHydrateDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new nHydrateDocView.
		/// </summary>
		protected nHydrateDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			nHydrateDocDataBase docData = this.DocData as nHydrateDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for nHydrateDocViewBase should be an nHydrateDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::nHydrate.Dsl.nHydrateDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::nHydrate.Dsl.nHydrateDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::nHydrate.Dsl.nHydrateToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::nHydrate.Dsl.nHydrateToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.nHydrateDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::nHydrate.Dsl.nHydrateHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::nHydrate.Dsl.nHydrateHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::nHydrate.Dsl.nHydrateHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);

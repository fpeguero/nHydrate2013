...
{ 
	...
	public partial class Persona_Roles_TransControllerBase : BaseController 
	{ 
		#region Members 
...
{
    var model = new Persona_Roles_TransModel();
...
public virtual ActionResult Load(GridRequestViewModel gridRequest)
{
    ...
    var allpersonaRolesTrans = Persona_Roles_TransModel.PageLoadAllPaging(1 + gridRequest.RowStartIndex/gridRequest.RowCount,
        gridRequest.RowCount, gridRequest.Search, pageOptions, out totalCount);

    var displayRecords = allpersonaRolesTrans.Count;
...
{
    var totalCount = 0;
    var allpersonaRolesTrans = Persona_Roles_TransModel.LoadAllPaging(this.GetSearchValue(), out totalCount);
    ...
    System.Globalization.DateTimeFormatInfo dtfi =
        System.Globalization.CultureInfo.CurrentCulture.DateTimeFormat;
    dtfi.DateSeparator = "/";
    return new CsvReportResult("Persona_Roles_Trans",
        allpersonaRolesTrans.Select(
            d =>
                new
                {
...

{
    try
    {
        var deleteModel  = Persona_Roles_TransModel.LoadByEntityKey(entityKey);
    ...
    return Content(string.Empty);
		...
		// ******************************************* 
        // URL: /Persona_Roles_Trans/Create 
        // ******************************************* 

public virtual ActionResult Create()
{
    var personaRolesTrans = new Persona_Roles_TransModel();
    ViewBag.IsNew = true;
    personaRolesTrans.Registro_Estado = "A";

    return View(personaRolesTrans);
}

//
// POST: /Usuarios/Create
[HttpPost]
public virtual ActionResult Create(Persona_Roles_TransModel personaRolesTrans)
{
    if (ModelState.IsValid)
    {

        //Campos Auditorias
        personaRolesTrans.Registro_Fecha = DateTime.Now;
        personaRolesTrans.Registro_Usuario = User.Identity.Name;
                
        var result = personaRolesTrans.Save();

        if (result)
        {
            return RedirectToAction("Edit", new { 
entityKey = personaRolesTrans.EntityKey});
        }
    ...
    return View(personaRolesTrans);
		...
		// ******************************************* 
        // URL: /Persona_Roles_Trans/Edit/id 
        // ******************************************* 

public virtual ActionResult Edit(string entityKey)
{

    var personaRolesTrans = Persona_Roles_TransModel.LoadByEntityKey(entityKey);
...
[HttpPost]
public virtual ActionResult Edit(Persona_Roles_TransModel personaRolesTrans)
{

...
{ 
    public partial class Turnos_Dias_TransController : Turnos_Dias_TransControllerBase 
    { 

    } 
 
	public partial class Turnos_Dias_TransControllerBase : BaseController 
	{ 
		#region Members 
...
{
    var model = new Turnos_Dias_TransModel();
...
public virtual ActionResult Load(GridRequestViewModel gridRequest)
{
    ...
    var allturnosDiasTrans = Turnos_Dias_TransModel.PageLoadAllPaging(1 + gridRequest.RowStartIndex/gridRequest.RowCount,
        gridRequest.RowCount, gridRequest.Search, pageOptions, out totalCount);

    var displayRecords = allturnosDiasTrans.Count;
...
{
    var totalCount = 0;
    var allturnosDiasTrans = Turnos_Dias_TransModel.LoadAllPaging(this.GetSearchValue(), out totalCount);
    ...
    System.Globalization.DateTimeFormatInfo dtfi =
        System.Globalization.CultureInfo.CurrentCulture.DateTimeFormat;
    dtfi.DateSeparator = "/";
    return new CsvReportResult("Turnos_Dias_Trans",
        allturnosDiasTrans.Select(
            d =>
                new
                {
...

{
    try
    {
        var deleteModel  = Turnos_Dias_TransModel.LoadByEntityKey(entityKey);
    ...
    return Content(string.Empty);
		...
		// ******************************************* 
        // URL: /Turnos_Dias_Trans/Create 
        // ******************************************* 

public virtual ActionResult Create()
{
    var turnosDiasTrans = new Turnos_Dias_TransModel();
    ViewBag.IsNew = true;
    turnosDiasTrans.Registro_Estado = "A";

    return View(turnosDiasTrans);
}

//
// POST: /Usuarios/Create
[HttpPost]
public virtual ActionResult Create(Turnos_Dias_TransModel turnosDiasTrans)
{
    if (ModelState.IsValid)
    {

        //Campos Auditorias
        turnosDiasTrans.Registro_Fecha = DateTime.Now;
        turnosDiasTrans.Registro_Usuario = User.Identity.Name;
                
        var result = turnosDiasTrans.Save();

        if (result)
        {
            return RedirectToAction("Edit", new { 
entityKey = turnosDiasTrans.EntityKey});
        }
    ...
    return View(turnosDiasTrans);
		...
		// ******************************************* 
        // URL: /Turnos_Dias_Trans/Edit/id 
        // ******************************************* 

public virtual ActionResult Edit(string entityKey)
{

    var turnosDiasTrans = Turnos_Dias_TransModel.LoadByEntityKey(entityKey);
...
[HttpPost]
public virtual ActionResult Edit(Turnos_Dias_TransModel turnosDiasTrans)
{

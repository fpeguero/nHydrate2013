...
{ 
    public partial class Notificaciones_Objetivo_TransController : Notificaciones_Objetivo_TransControllerBase 
    { 

    } 
 
	public partial class Notificaciones_Objetivo_TransControllerBase : BaseController 
	{ 
		#region Members 
...
{
    var model = new Notificaciones_Objetivo_TransModel();
...
public virtual ActionResult Load(GridRequestViewModel gridRequest)
{
    ...
    var allnotificacionesObjetivoTrans = Notificaciones_Objetivo_TransModel.PageLoadAllPaging(1 + gridRequest.RowStartIndex/gridRequest.RowCount,
        gridRequest.RowCount, gridRequest.Search, pageOptions, out totalCount);

    var displayRecords = allnotificacionesObjetivoTrans.Count;
    ...
    return Json(new
    {
        ...
        aaData =
            allnotificacionesObjetivoTrans.Select(
                d =>
                    new
                    {
...
{
    var totalCount = 0;
    var allnotificacionesObjetivoTrans = Notificaciones_Objetivo_TransModel.LoadAllPaging(this.GetSearchValue(), out totalCount);
    ...
    System.Globalization.DateTimeFormatInfo dtfi =
        System.Globalization.CultureInfo.CurrentCulture.DateTimeFormat;
    dtfi.DateSeparator = "/";
    return new CsvReportResult("Notificaciones_Objetivo_Trans",
        allnotificacionesObjetivoTrans.Select(
            d =>
                new
                {
...

{
    try
    {
        var deleteModel  = Notificaciones_Objetivo_TransModel.LoadByEntityKey(entityKey);
    ...
    return Content(string.Empty);
		...
		// ******************************************* 
        // URL: /Notificaciones_Objetivo_Trans/Create 
        // ******************************************* 

public virtual ActionResult Create()
{
    var notificacionesObjetivoTrans = new Notificaciones_Objetivo_TransModel();
    ViewBag.IsNew = true;
    notificacionesObjetivoTrans.Registro_Estado = "A";

    return View(notificacionesObjetivoTrans);
}

//
// POST: /Usuarios/Create
[HttpPost]
public virtual ActionResult Create(Notificaciones_Objetivo_TransModel notificacionesObjetivoTrans)
{
    if (ModelState.IsValid)
    {

        //Campos Auditorias
        notificacionesObjetivoTrans.Registro_Fecha = DateTime.Now;
        notificacionesObjetivoTrans.Registro_Usuario = User.Identity.Name;
                
        var result = notificacionesObjetivoTrans.Save();

        if (result)
        {
            return RedirectToAction("Edit", new { 
entityKey = notificacionesObjetivoTrans.EntityKey});
        }
    ...
    return View(notificacionesObjetivoTrans);
		...
		// ******************************************* 
        // URL: /Notificaciones_Objetivo_Trans/Edit/id 
        // ******************************************* 

public virtual ActionResult Edit(string entityKey)
{

    var notificacionesObjetivoTrans = Notificaciones_Objetivo_TransModel.LoadByEntityKey(entityKey);
...
[HttpPost]
public virtual ActionResult Edit(Notificaciones_Objetivo_TransModel notificacionesObjetivoTrans)
{

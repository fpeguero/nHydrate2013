...
{ 
    public partial class Zonas_Encargados_TransController : Zonas_Encargados_TransControllerBase 
    { 

    } 
 
	public partial class Zonas_Encargados_TransControllerBase : BaseController 
	{ 
		#region Members 
...
{
    var model = new Zonas_Encargados_TransModel();
...
public virtual ActionResult Load(GridRequestViewModel gridRequest)
{
    ...
    var allzonasEncargadosTrans = Zonas_Encargados_TransModel.PageLoadAllPaging(1 + gridRequest.RowStartIndex/gridRequest.RowCount,
        gridRequest.RowCount, gridRequest.Search, pageOptions, out totalCount);

    var displayRecords = allzonasEncargadosTrans.Count;
    ...
    return Json(new
    {
        ...
        aaData =
            allzonasEncargadosTrans.Select(
                d =>
                    new
                    {
...
{
    var totalCount = 0;
    var allzonasEncargadosTrans = Zonas_Encargados_TransModel.LoadAllPaging(this.GetSearchValue(), out totalCount);
    ...
    System.Globalization.DateTimeFormatInfo dtfi =
        System.Globalization.CultureInfo.CurrentCulture.DateTimeFormat;
    dtfi.DateSeparator = "/";
    return new CsvReportResult("Zonas_Encargados_Trans",
        allzonasEncargadosTrans.Select(
            d =>
                new
                {
...

{
    try
    {
        var deleteModel  = Zonas_Encargados_TransModel.LoadByEntityKey(entityKey);
    ...
    return Content(string.Empty);
		...
		// ******************************************* 
        // URL: /Zonas_Encargados_Trans/Create 
        // ******************************************* 

public virtual ActionResult Create()
{
    var zonasEncargadosTrans = new Zonas_Encargados_TransModel();
    ViewBag.IsNew = true;
    zonasEncargadosTrans.Registro_Estado = "A";

    return View(zonasEncargadosTrans);
}

//
// POST: /Usuarios/Create
[HttpPost]
public virtual ActionResult Create(Zonas_Encargados_TransModel zonasEncargadosTrans)
{
    if (ModelState.IsValid)
    {

        //Campos Auditorias
        zonasEncargadosTrans.Registro_Fecha = DateTime.Now;
        zonasEncargadosTrans.Registro_Usuario = User.Identity.Name;
                
        var result = zonasEncargadosTrans.Save();

        if (result)
        {
            return RedirectToAction("Edit", new { 
entityKey = zonasEncargadosTrans.EntityKey});
        }
    ...
    return View(zonasEncargadosTrans);
		...
		// ******************************************* 
        // URL: /Zonas_Encargados_Trans/Edit/id 
        // ******************************************* 

public virtual ActionResult Edit(string entityKey)
{

    var zonasEncargadosTrans = Zonas_Encargados_TransModel.LoadByEntityKey(entityKey);
...
[HttpPost]
public virtual ActionResult Edit(Zonas_Encargados_TransModel zonasEncargadosTrans)
{

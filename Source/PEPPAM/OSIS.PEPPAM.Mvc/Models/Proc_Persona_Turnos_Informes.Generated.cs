...
namespace OSIS.PEPPAM.Mvc.Models
{
    ...
    public partial class Proc_Persona_Turnos_InformesBase
    {


        
        public Proc_Persona_Turnos_InformesBase()
        {
        }
...
public static OSIS.PEPPAM.Mvc.Models.Proc_Persona_Turnos_InformesModel LoadOne(int? personaSecuencia)
        {
            var _loadOne = OSIS.PEPPAM.BOM.Proc_Persona_Turnos_Informes.LoadOne(
personaSecuencia);
            if ((_loadOne == null))
            {
                return new OSIS.PEPPAM.Mvc.Models.Proc_Persona_Turnos_InformesModel();
            }


	        var _procPersonaTurnosInformes = new OSIS.PEPPAM.Mvc.Models.Proc_Persona_Turnos_InformesModel()
            {
            ...
            return _procPersonaTurnosInformes;
            }


public static List<OSIS.PEPPAM.Mvc.Models.Proc_Persona_Turnos_InformesModel> Load(int? personaSecuencia)
        {
            var _load = OSIS.PEPPAM.BOM.Proc_Persona_Turnos_Informes.Load(
personaSecuencia);

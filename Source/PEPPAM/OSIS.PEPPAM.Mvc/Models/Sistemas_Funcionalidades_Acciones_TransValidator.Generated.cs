...
namespace OSIS.PEPPAM.Mvc.Models 
{
	...
	public partial class Sistemas_Funcionalidades_Acciones_TransValidator : AbstractValidator<Sistemas_Funcionalidades_Acciones_TransModel>
	{
	public void Validators()
	{
		//Numeric,
		RuleFor(x => x.Funcionalidad_Numero_Url).Numeric().WithMessage(Messages.GetOrSetMensaje("MENSAJE_ERROR_NUMERIC"));
		//Required,

...
namespace OSIS.PEPPAM.Mvc.Models
{
    ...
    public partial class Proc_Puestos_Hombres_Clave_FaltantesBase
    {


        
        public Proc_Puestos_Hombres_Clave_FaltantesBase()
        {
        }
...
public static OSIS.PEPPAM.Mvc.Models.Proc_Puestos_Hombres_Clave_FaltantesModel LoadOne(int? rutaSecuencia,int? semanaCodigo,int? zonaSecuencia)
        {
            var _loadOne = OSIS.PEPPAM.BOM.Proc_Puestos_Hombres_Clave_Faltantes.LoadOne(
rutaSecuencia,semanaCodigo,zonaSecuencia);
            if ((_loadOne == null))
            {
                return new OSIS.PEPPAM.Mvc.Models.Proc_Puestos_Hombres_Clave_FaltantesModel();
            }


	        var _procPuestosHombresClaveFaltantes = new OSIS.PEPPAM.Mvc.Models.Proc_Puestos_Hombres_Clave_FaltantesModel()
            {
            ...
            return _procPuestosHombresClaveFaltantes;
            }


public static List<OSIS.PEPPAM.Mvc.Models.Proc_Puestos_Hombres_Clave_FaltantesModel> Load(int? rutaSecuencia,int? semanaCodigo,int? zonaSecuencia)
        {
            var _load = OSIS.PEPPAM.BOM.Proc_Puestos_Hombres_Clave_Faltantes.Load(
rutaSecuencia,semanaCodigo,zonaSecuencia);
            ...
            if ((_load == null))
            {
                return new List<OSIS.PEPPAM.Mvc.Models.Proc_Puestos_Hombres_Clave_FaltantesModel>();
            }

            var result = _load.Select(
                x =>
                    new OSIS.PEPPAM.Mvc.Models.Proc_Puestos_Hombres_Clave_FaltantesModel()
                    {

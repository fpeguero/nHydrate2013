...
namespace OSIS.PEPPAM.Mvc.Models
{
    ...
    public partial class Proc_Puestos_Horario_Turnos_FaltantesBase
    {


        
        public Proc_Puestos_Horario_Turnos_FaltantesBase()
        {
        }
...
public static OSIS.PEPPAM.Mvc.Models.Proc_Puestos_Horario_Turnos_FaltantesModel LoadOne(int? horarioSecuencia,int? rutaSecuencia,int? zonaSecuencia)
        {
            var _loadOne = OSIS.PEPPAM.BOM.Proc_Puestos_Horario_Turnos_Faltantes.LoadOne(
horarioSecuencia,rutaSecuencia,zonaSecuencia);
            if ((_loadOne == null))
            {
                return new OSIS.PEPPAM.Mvc.Models.Proc_Puestos_Horario_Turnos_FaltantesModel();
            }


	        var _procPuestosHorarioTurnosFaltantes = new OSIS.PEPPAM.Mvc.Models.Proc_Puestos_Horario_Turnos_FaltantesModel()
            {
            ...
            return _procPuestosHorarioTurnosFaltantes;
            }


public static List<OSIS.PEPPAM.Mvc.Models.Proc_Puestos_Horario_Turnos_FaltantesModel> Load(int? horarioSecuencia,int? rutaSecuencia,int? zonaSecuencia)
        {
            var _load = OSIS.PEPPAM.BOM.Proc_Puestos_Horario_Turnos_Faltantes.Load(
horarioSecuencia,rutaSecuencia,zonaSecuencia);
            ...
            if ((_load == null))
            {
                return new List<OSIS.PEPPAM.Mvc.Models.Proc_Puestos_Horario_Turnos_FaltantesModel>();
            }

            var result = _load.Select(
                x =>
                    new OSIS.PEPPAM.Mvc.Models.Proc_Puestos_Horario_Turnos_FaltantesModel()
                    {

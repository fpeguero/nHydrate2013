...
namespace OSIS.PEPPAM.Mvc.Models
{
    ...
    public partial class Proc_Persona_TurnosBase
    {


        
        public Proc_Persona_TurnosBase()
        {
        }
...
public static OSIS.PEPPAM.Mvc.Models.Proc_Persona_TurnosModel LoadOne(int? personaSecuencia)
        {
            var _loadOne = OSIS.PEPPAM.BOM.Proc_Persona_Turnos.LoadOne(
personaSecuencia);
            if ((_loadOne == null))
            {
                return new OSIS.PEPPAM.Mvc.Models.Proc_Persona_TurnosModel();
            }


	        var _procPersonaTurnos = new OSIS.PEPPAM.Mvc.Models.Proc_Persona_TurnosModel()
            {
            ...
            return _procPersonaTurnos;
            }


public static List<OSIS.PEPPAM.Mvc.Models.Proc_Persona_TurnosModel> Load(int? personaSecuencia)
        {
            var _load = OSIS.PEPPAM.BOM.Proc_Persona_Turnos.Load(
personaSecuencia);
            ...
            if ((_load == null))
            {
                return new List<OSIS.PEPPAM.Mvc.Models.Proc_Persona_TurnosModel>();
            }

            var result = _load.Select(
                x =>
                    new OSIS.PEPPAM.Mvc.Models.Proc_Persona_TurnosModel()
                    {

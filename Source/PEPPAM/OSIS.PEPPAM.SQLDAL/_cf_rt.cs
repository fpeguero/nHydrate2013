...
namespace OSIS.PEPPAM.BOM.Resources
{
    using System;
    ...
    public sealed partial class Manager
    {
        ...
        private Manager()
        {
            this._resources = new System.Resources.ResourceManager("OSIS.PEPPAM.BOM.ResourceDatos", System.Reflection.Assembly.GetExecutingAssembly());
            try
            {
    ...
    public sealed partial class ValueValidationFailureHandler : CodeFluent.Runtime.Rules.BaseValueValidationFailureHandler
    {
        ...
        private static OSIS.PEPPAM.BOM.Resources.ValueValidationFailureHandler _current = new OSIS.PEPPAM.BOM.Resources.ValueValidationFailureHandler();
        
        public ValueValidationFailureHandler()
        {
        }
        
        public static OSIS.PEPPAM.BOM.Resources.ValueValidationFailureHandler Current
        {
            get
            {
                return OSIS.PEPPAM.BOM.Resources.ValueValidationFailureHandler._current;
            }
        }
        ...
        public override string GetMessage(System.Globalization.CultureInfo culture, CodeFluent.Runtime.Rules.ValueValidator validator, string failureCode, object[] arguments)
        {
            ...
            string message = OSIS.PEPPAM.BOM.Resources.Manager.GetString(culture, code, arguments);
            if ((message == code))
            {
                return baseMessage;
            }
...
namespace OSIS.PEPPAM.BOM
{
    ...
    public sealed partial class Constants
    {
        ...
        public const string OSIS_PEPPAM_BOMStoreName = "OSIS.PEPPAM.BOM";

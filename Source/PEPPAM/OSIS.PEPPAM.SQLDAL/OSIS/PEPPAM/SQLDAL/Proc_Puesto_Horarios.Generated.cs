...
namespace OSIS.PEPPAM.BOM
{
    ...
    public partial class Proc_Puesto_Horarios : CodeFluent.Runtime.ICodeFluentLightEntity, System.ComponentModel.INotifyPropertyChanged
    {
        ...
        public static OSIS.PEPPAM.BOM.Proc_Puesto_Horarios LoadOne(int horarioSecuencia,int puestoNumero)
        {
            ...
            OSIS.PEPPAM.BOM.Proc_Puesto_Horarios  result = new OSIS.PEPPAM.BOM.Proc_Puesto_Horarios();
            ...
            persistence.AddRawParameter("@Horario_Secuencia", horarioSecuencia);
            persistence.AddRawParameter("@Puesto_Numero", puestoNumero);
         ...
         public static System.Collections.Generic.List<OSIS.PEPPAM.BOM.Proc_Puesto_Horarios> Load(int horarioSecuencia,int puestoNumero)
        {
            System.Collections.Generic.List<OSIS.PEPPAM.BOM.Proc_Puesto_Horarios> load = new System.Collections.Generic.List<OSIS.PEPPAM.BOM.Proc_Puesto_Horarios>();
            CodeFluent.Runtime.CodeFluentPersistence persistence = CodeFluentContext.Get(OSIS.PEPPAM.BOM.Constants.OSIS_PEPPAM_BOMStoreName).Persistence;
            persistence.CreateStoredProcedureCommand(null, "Proc_Puesto_Horarios", null, "Proc_Puesto_Horarios");
            ...
            try
            {
                ...
                {
                    OSIS.PEPPAM.BOM.Proc_Puesto_Horarios _load = new OSIS.PEPPAM.BOM.Proc_Puesto_Horarios();

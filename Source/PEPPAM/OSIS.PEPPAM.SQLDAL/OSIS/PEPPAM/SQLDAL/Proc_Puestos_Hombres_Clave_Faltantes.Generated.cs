...
namespace OSIS.PEPPAM.BOM
{
    ...
    public partial class Proc_Puestos_Hombres_Clave_Faltantes : CodeFluent.Runtime.ICodeFluentLightEntity, System.ComponentModel.INotifyPropertyChanged
    {
        ...
        public Proc_Puestos_Hombres_Clave_Faltantes()
        {
        }
        ...
        public static OSIS.PEPPAM.BOM.Proc_Puestos_Hombres_Clave_Faltantes LoadOne(int? rutaSecuencia,int? semanaCodigo,int? zonaSecuencia)
        {
            OSIS.PEPPAM.BOM.Proc_Puestos_Hombres_Clave_Faltantes  result = new OSIS.PEPPAM.BOM.Proc_Puestos_Hombres_Clave_Faltantes();
            ...
            persistence.CreateStoredProcedureCommand(null, "Proc_Puestos_Hombres_Clave_Faltantes", null, "Proc_Puestos_Hombres_Clave_Faltantes");
            if (rutaSecuencia.HasValue)
            persistence.AddRawParameter("@Ruta_Secuencia", rutaSecuencia.Value);
            if (semanaCodigo.HasValue)
            persistence.AddRawParameter("@Semana_Codigo", semanaCodigo.Value);
         ...
         public static System.Collections.Generic.List<OSIS.PEPPAM.BOM.Proc_Puestos_Hombres_Clave_Faltantes> Load(int? rutaSecuencia,int? semanaCodigo,int? zonaSecuencia)
        {
            System.Collections.Generic.List<OSIS.PEPPAM.BOM.Proc_Puestos_Hombres_Clave_Faltantes> load = new System.Collections.Generic.List<OSIS.PEPPAM.BOM.Proc_Puestos_Hombres_Clave_Faltantes>();
            CodeFluent.Runtime.CodeFluentPersistence persistence = CodeFluentContext.Get(OSIS.PEPPAM.BOM.Constants.OSIS_PEPPAM_BOMStoreName).Persistence;
            persistence.CreateStoredProcedureCommand(null, "Proc_Puestos_Hombres_Clave_Faltantes", null, "Proc_Puestos_Hombres_Clave_Faltantes");
            persistence.AddParameter("@Ruta_Secuencia", rutaSecuencia);
            persistence.AddParameter("@Semana_Codigo", semanaCodigo);
            ...
            try
            {
                ...
                {
                    OSIS.PEPPAM.BOM.Proc_Puestos_Hombres_Clave_Faltantes _load = new OSIS.PEPPAM.BOM.Proc_Puestos_Hombres_Clave_Faltantes();

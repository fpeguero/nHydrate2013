...
namespace OSIS.PEPPAM.BOM
{
    ...
    public partial class Proc_Persona_Turnos : CodeFluent.Runtime.ICodeFluentLightEntity, System.ComponentModel.INotifyPropertyChanged
    {
        ...
        public static OSIS.PEPPAM.BOM.Proc_Persona_Turnos LoadOne(int? personaSecuencia)
        {
            OSIS.PEPPAM.BOM.Proc_Persona_Turnos  result = new OSIS.PEPPAM.BOM.Proc_Persona_Turnos();
            ...
            persistence.CreateStoredProcedureCommand(null, "Proc_Persona_Turnos", null, "Proc_Persona_Turnos");
         ...
         public static System.Collections.Generic.List<OSIS.PEPPAM.BOM.Proc_Persona_Turnos> Load(int? personaSecuencia)
        {
            System.Collections.Generic.List<OSIS.PEPPAM.BOM.Proc_Persona_Turnos> load = new System.Collections.Generic.List<OSIS.PEPPAM.BOM.Proc_Persona_Turnos>();
            CodeFluent.Runtime.CodeFluentPersistence persistence = CodeFluentContext.Get(OSIS.PEPPAM.BOM.Constants.OSIS_PEPPAM_BOMStoreName).Persistence;
            persistence.CreateStoredProcedureCommand(null, "Proc_Persona_Turnos", null, "Proc_Persona_Turnos");
            ...
            try
            {
                ...
                {
                    OSIS.PEPPAM.BOM.Proc_Persona_Turnos _load = new OSIS.PEPPAM.BOM.Proc_Persona_Turnos();

...
namespace OSIS.PEPPAM.BOM
{
    ...
    public partial class Horas_CataCollection : System.Collections.IList, CodeFluent.Runtime.ICodeFluentSet, System.Collections.Generic.IList<OSIS.PEPPAM.BOM.Horas_Cata>, System.ComponentModel.IRaiseItemChangedEvents, System.ICloneable, System.ComponentModel.INotifyPropertyChanged, System.Collections.Specialized.INotifyCollectionChanged, System.ComponentModel.IBindingList, System.ComponentModel.ICancelAddNew
    {
        ...
        private System.Collections.Generic.List<OSIS.PEPPAM.BOM.Horas_Cata> _baseList = new System.Collections.Generic.List<OSIS.PEPPAM.BOM.Horas_Cata>();
        ...
        [System.NonSerializedAttribute()]
        private CodeFluent.Runtime.Utilities.BindingListManager<OSIS.PEPPAM.BOM.Horas_Cata> _blm852358831;
        ...
        public Horas_CataCollection()        {
            this._blm852358831 = new CodeFluent.Runtime.Utilities.BindingListManager<OSIS.PEPPAM.BOM.Horas_Cata>(this);
        }
        ...
        [System.Xml.Serialization.XmlIgnoreAttribute()]
        protected System.Collections.Generic.List<OSIS.PEPPAM.BOM.Horas_Cata> BaseList
        {
            get
            {
        ...
        public OSIS.PEPPAM.BOM.Horas_Cata this[int index]
        {
            get
            {
                return ((OSIS.PEPPAM.BOM.Horas_Cata)(this.BaseList[index]));
            }
            set
            {
        ...
        object System.Collections.IList.this[int index]
        {
            ...
            set
            {
                this.BaseList[index] = ((OSIS.PEPPAM.BOM.Horas_Cata)(value));
            }
        }
        ...
        protected virtual void Relate(OSIS.PEPPAM.BOM.Horas_Cata item, CodeFluent.Runtime.CodeFluentRelationType relationType)
        {
            ((CodeFluent.Runtime.ICodeFluentSet)(this)).Relations[item] = relationType;
        }
        
        public int Add(OSIS.PEPPAM.BOM.Horas_Cata horasCata)
        {
            int localAdd = this.BaseList.Count;
            this.BaseAdd(horasCata);
            return localAdd;
        }
        
        protected virtual int BaseAdd(OSIS.PEPPAM.BOM.Horas_Cata horasCata)
        {
            if ((horasCata == null))
            {
            ...
            if (
            (horasCata.Hora_Secuencia == -1)
                  )            {
                CodeFluent.Runtime.CodeFluentRuntimeException.Throw("invalidEntityKey", "Hora_Secuencia", "horasCata", "OSIS.PEPPAM.BOM.Horas_Cata");
            }
            int localAdd = this.BaseList.Count;
            this.BaseList.Add(horasCata);
            this.OnCollectionChanged(new CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Add, horasCata, localAdd));
        ...
        int System.Collections.IList.Add(object value)
        {
            ...
            try
            {
                horasCata = ((OSIS.PEPPAM.BOM.Horas_Cata)(value));
            }
            ...
            int localAdd = this.Add(horasCata);
            return localAdd;
        }
        
        void System.Collections.Generic.ICollection<OSIS.PEPPAM.BOM.Horas_Cata>.Add(OSIS.PEPPAM.BOM.Horas_Cata horasCata)
        {
            this.BaseAdd(horasCata);
        }
        
        public virtual OSIS.PEPPAM.BOM.Horas_Cata AddByEntityKey(string key)
        {
            OSIS.PEPPAM.BOM.Horas_Cata horasCata = OSIS.PEPPAM.BOM.Horas_Cata.LoadByEntityKey(key);
            if (((horasCata != null) 
                        && (this.Contains(horasCata) == false)))
            {
                this.Add(horasCata);
            }
            return horasCata;
        ...
        public virtual void Sort(System.Collections.Generic.IComparer<OSIS.PEPPAM.BOM.Horas_Cata> comparer)
        {
            this.BaseList.Sort(comparer);
        }
        
        public void CopyTo(OSIS.PEPPAM.BOM.Horas_Cata[] array, int index)
        {
            this.BaseCopyTo(array, index);
        }
        
        protected virtual void BaseCopyTo(OSIS.PEPPAM.BOM.Horas_Cata[] array, int index)
        {
        ...
        public bool Contains(OSIS.PEPPAM.BOM.Horas_Cata horasCata)
        {
            bool localContains = this.BaseContains(horasCata);
            return localContains;
        }
        
        protected virtual bool BaseContains(OSIS.PEPPAM.BOM.Horas_Cata horasCata)
        {
            if ((horasCata == null))
            {
                return false;
            }
            bool localContains = this.BaseList.Contains(horasCata);
            return localContains;
        }
        ...
        bool System.Collections.IList.Contains(object value)
        {
            ...
            return this.Contains(horasCata);
        }
        
        public int IndexOf(OSIS.PEPPAM.BOM.Horas_Cata horasCata)
        {
            int localIndexOf = this.BaseIndexOf(horasCata);
            return localIndexOf;
        }
        
        protected virtual int BaseIndexOf(OSIS.PEPPAM.BOM.Horas_Cata horasCata)
        {
            if ((horasCata == null))
            {
                return -1;
            }
            int localIndexOf = this.BaseList.IndexOf(horasCata);
            return localIndexOf;
        }
        ...
        int System.Collections.IList.IndexOf(object value)
        {
            OSIS.PEPPAM.BOM.Horas_Cata horasCata;
			horasCata = value as OSIS.PEPPAM.BOM.Horas_Cata;
            return this.IndexOf(horasCata);
        }
        
        public void Insert(int index, OSIS.PEPPAM.BOM.Horas_Cata horasCata)
        {
            this.BaseInsert(index, horasCata);
        }
        
        protected virtual void BaseInsert(int index, OSIS.PEPPAM.BOM.Horas_Cata horasCata)
        {
            if ((horasCata == null))
            {
                throw new System.ArgumentNullException("horasCata");
            }
            this.BaseList.Insert(index, horasCata);
            this.OnCollectionChanged(new CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Add, horasCata, index));
        ...
        public virtual void Clear()
        {
            ...
            {
                OSIS.PEPPAM.BOM.Horas_Cata horasCata = this[0];
                this.BaseRemove(horasCata);
            }
        ...
        public bool Remove(OSIS.PEPPAM.BOM.Horas_Cata horasCata)
        {
            return this.BaseRemove(horasCata);
        }
        
        protected virtual bool BaseRemove(OSIS.PEPPAM.BOM.Horas_Cata horasCata)
        {
            if ((horasCata == null))
            {
                throw new System.ArgumentNullException("horasCata");
            }
            int index = this.IndexOf(horasCata);
            this.OnListChanged(new System.ComponentModel.ListChangedEventArgs(((System.ComponentModel.ListChangedType)(CodeFluent.Runtime.Utilities.SortableBindingList<OSIS.PEPPAM.BOM.Horas_Cata>.ListChangedTypeDeleting)), index));
            bool ret;
            ret = this.BaseList.Remove(horasCata);
            this.OnCollectionChanged(new CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Remove, horasCata, index));
        ...
        void System.Collections.IList.Remove(object value)
        {
            OSIS.PEPPAM.BOM.Horas_Cata horasCata;
			horasCata = value as OSIS.PEPPAM.BOM.Horas_Cata;
            this.Remove(horasCata);
        }
        
        public virtual void RemoveAt(int index)
        {
            this.OnListChanged(new System.ComponentModel.ListChangedEventArgs(((System.ComponentModel.ListChangedType)(CodeFluent.Runtime.Utilities.SortableBindingList<OSIS.PEPPAM.BOM.Horas_Cata>.ListChangedTypeDeleting)), index));
            OSIS.PEPPAM.BOM.Horas_Cata horasCata = this.BaseList[index];
            this.BaseList.RemoveAt(index);
            this.OnCollectionChanged(new CodeFluent.Runtime.Utilities.IndexedCollectionChangeEventArgs(System.ComponentModel.CollectionChangeAction.Remove, horasCata, index));
            this.OnListChanged(new System.ComponentModel.ListChangedEventArgs(System.ComponentModel.ListChangedType.ItemDeleted, index));
        }
        
        public virtual System.Collections.Generic.IEnumerator<OSIS.PEPPAM.BOM.Horas_Cata> GetEnumerator()
        {
            System.Collections.Generic.IEnumerator<OSIS.PEPPAM.BOM.Horas_Cata> e = this.BaseList.GetEnumerator();
            return e;
        }
        ...
        public virtual void SaveAll()
        {
            ...
            {
                OSIS.PEPPAM.BOM.Horas_Cata horasCata = this[index];
                horasCata.Save();
                if ((horasCata.EntityState == CodeFluent.Runtime.CodeFluentEntityState.Deleted))
                {
                    this.Remove(horasCata);
                }
            }
        ...
        private void LoadAll(int pageIndex, int pageSize, CodeFluent.Runtime.PageOptions pageOptions, System.Data.IDataReader reader)
        {
                        ...
                        && (count < pageSize))); readerRead = reader.Read())
            {
                ...
                if ((CodeFluent.Runtime.CodeFluentPersistence.CanAddEntity(pageIndex, pageSize, pageOptions, readCount) == true))
                {
                    ...
                    ((CodeFluent.Runtime.ICodeFluentEntity)(horasCata)).ReadRecord(reader);
                    if (true)
                    {
                        this.BaseAdd(horasCata);
                        count = (count + 1);
        ...
        public static OSIS.PEPPAM.BOM.Horas_CataCollection PageLoadAll(int pageIndex, int pageSize, CodeFluent.Runtime.PageOptions pageOptions)
        {
            if ((pageIndex < 0))
            {
                pageIndex = 0;
            ...
            OSIS.PEPPAM.BOM.Horas_CataCollection ret = new OSIS.PEPPAM.BOM.Horas_CataCollection();
            System.Data.IDataReader reader = null;
            try
            {
                reader = OSIS.PEPPAM.BOM.Horas_CataCollection.PageDataLoadAll(pageOptions);
                if ((reader == null))
                {
                    return ret;
                }
        ...
        [System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, true)]
        public static OSIS.PEPPAM.BOM.Horas_CataCollection LoadAll()
        {
        ...
        public static System.Data.IDataReader PageDataLoadAll(CodeFluent.Runtime.PageOptions pageOptions)
        {
            ...
            persistence.CreateStoredProcedureCommand(null, "Proc_Horas_Cata", "LoadAll");
            if ((pageOptions != null))
            {
        ...
        {
            System.Data.IDataReader reader = OSIS.PEPPAM.BOM.Horas_CataCollection.PageDataLoadAll(null);
            return reader;
        }
        ...
        public virtual void CopyTo(OSIS.PEPPAM.BOM.Horas_CataCollection collection, bool deep)
        {
            if ((typeof(System.ICloneable).IsAssignableFrom(typeof(OSIS.PEPPAM.BOM.Horas_Cata)) == false))
            {
                deep = false;
            }
            System.Collections.Generic.IEnumerator<OSIS.PEPPAM.BOM.Horas_Cata> enumerator = this.GetEnumerator();
            bool b;
            for (b = enumerator.MoveNext(); b; b = enumerator.MoveNext())
            {
                if ((deep == true))
                {
                    collection.Add(((OSIS.PEPPAM.BOM.Horas_Cata)(((System.ICloneable)(enumerator.Current)).Clone())));
                }
                else
                {
        ...
        public virtual OSIS.PEPPAM.BOM.Horas_CataCollection Clone(bool deep)
        {
            OSIS.PEPPAM.BOM.Horas_CataCollection ret = new OSIS.PEPPAM.BOM.Horas_CataCollection();
        ...
        {
            OSIS.PEPPAM.BOM.Horas_Cata add = new OSIS.PEPPAM.BOM.Horas_Cata();
            System.ComponentModel.AddingNewEventArgs e = new System.ComponentModel.AddingNewEventArgs(add);
            this.OnAddingNew(e);
            add = ((OSIS.PEPPAM.BOM.Horas_Cata)(e.NewObject));
            if ((add == null))
            {
                add = new OSIS.PEPPAM.BOM.Horas_Cata();
            }
        ...
        public void AddRange(System.Collections.Generic.IEnumerable<OSIS.PEPPAM.BOM.Horas_Cata> collection)
        {
            CodeFluent.Runtime.Utilities.ConvertUtilities.AddRange(this, collection);
        }
        
        [System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, true)]
        public static OSIS.PEPPAM.BOM.Horas_CataCollection PageLoadAll(int pageIndex, int pageSize)
        {
            return OSIS.PEPPAM.BOM.Horas_CataCollection.PageLoadAll(pageIndex, pageSize, null);
        }
        ...
        [System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, true)]
        public static OSIS.PEPPAM.BOM.Horas_CataCollection PageLoadAllPaging(int pageIndex, int pageSize,string searchString, CodeFluent.Runtime.PageOptions pageOptions)
        {
            if ((pageIndex < 0))
            {
                pageIndex = 0;
            ...
            try
            {
                reader = OSIS.PEPPAM.BOM.Horas_CataCollection.PageDataLoadAllPaging(pageIndex, pageSize, searchString, pageOptions);
                if ((reader == null))
                {
                    return ret;
                }
        ...
        [System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, true)]
        public static OSIS.PEPPAM.BOM.Horas_CataCollection LoadAllPaging(int pageIndex, int pageSize,string searchString)
        {
            OSIS.PEPPAM.BOM.Horas_CataCollection ret = OSIS.PEPPAM.BOM.Horas_CataCollection.PageLoadAllPaging(pageIndex, pageSize,searchString, null);
            return ret;
        }
        ...
        {
            CodeFluent.Runtime.CodeFluentPersistence persistence = CodeFluentContext.Get(OSIS.PEPPAM.BOM.Constants.OSIS_PEPPAM_BOMStoreName).Persistence;
            persistence.CreateStoredProcedureCommand(null, "Proc_Horas_Cata", "Paging");
        ...
        {
            System.Data.IDataReader reader = OSIS.PEPPAM.BOM.Horas_CataCollection.PageDataLoadAllPaging( pageIndex,  pageSize,  searchString,null);
            return reader;
        }
        
        [System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, true)]
        public static OSIS.PEPPAM.BOM.Horas_CataCollection PageLoadAllPaging(int pageIndex, int pageSize, string searchString)
        {
            return OSIS.PEPPAM.BOM.Horas_CataCollection.PageLoadAllPaging(pageIndex, pageSize, searchString, null);
        }
        ...
        [System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, true)]
        public static OSIS.PEPPAM.BOM.Horas_CataCollection PageLoadAllCustomPaging(int pageIndex, int pageSize,string searchString, string procName, Dictionary<string, string> parametes, CodeFluent.Runtime.PageOptions pageOptions)
        {
            if ((pageIndex < 0))
            {
                pageIndex = 0;
            ...
            try
            {
                reader = OSIS.PEPPAM.BOM.Horas_CataCollection.PageDataLoadAllCustomPaging(pageIndex, pageSize, searchString, procName, parametes, pageOptions);
                if ((reader == null))
                {
                    return ret;
                }
        ...
        [System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, true)]
        public static OSIS.PEPPAM.BOM.Horas_CataCollection LoadAllCustomPaging(int pageIndex, int pageSize,string searchString, string procName, Dictionary<string, string> parametes)
        {
            OSIS.PEPPAM.BOM.Horas_CataCollection ret = OSIS.PEPPAM.BOM.Horas_CataCollection.PageLoadAllCustomPaging(pageIndex, pageSize,searchString, procName, parametes, null);
            return ret;
        }
        ...
        {
            System.Data.IDataReader reader = OSIS.PEPPAM.BOM.Horas_CataCollection.PageDataLoadAllCustomPaging( pageIndex,  pageSize,  searchString, procName, parametes, null);
            return reader;
        }
        
        [System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, true)]
        public static OSIS.PEPPAM.BOM.Horas_CataCollection PageLoadAllCustomPaging(int pageIndex, int pageSize, string searchString, string procName, Dictionary<string, string> parametes)
        {
            return OSIS.PEPPAM.BOM.Horas_CataCollection.PageLoadAllCustomPaging(pageIndex, pageSize, searchString, procName, parametes, null);
        }

...
namespace nHydrate.Dsl
{
	...
	/// </remarks>
	public partial class nHydrateHelpKeywordHelper : nHydrateHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new nHydrateHelpKeywordHelper.
		/// </summary>
		protected nHydrateHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the nHydrateHelpKeywordHelper.
		/// </summary>
		public static nHydrateHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class nHydrateHelpKeywordHelperBase
	{
		...
		/// </summary>
		protected nHydrateHelpKeywordHelperBase()
			: base() { }

namespace nHydrate.Dsl.Design.Forms
{
	partial class CopyrightForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.txtText.Location = new System.Drawing.Point(8, 71);
			this.txtText.Multiline = true;
			this.txtText.Name = "txtText";
			this.txtText.Size = new System.Drawing.Size(517, 210);
			...
			this.label1.Text = "Enter the copyright for all files. This text will be prepended to all generated f" +
    "iles as a copyright notice.";
			// 
			// pictureBox1
			// 
